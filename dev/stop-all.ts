...
const buffered = execSync(`find ${dialectsDirectory} | grep dialects | grep stop.sh`).toString();
const stopScripts = buffered.split(/\n/g);

stopScripts.forEach(scriptFullFileName => {  
