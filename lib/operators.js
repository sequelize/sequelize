...
const Op = {
  ...
  cteAdd: Symbol('cteAdd'),
  cteSub: Symbol('cteSub'),
  cteMul: Symbol('cteMul'),
  cteDiv: Symbol('cteDiv'),
  cteModel: Symbol('cteModel'),
  cteCte: Symbol('cteCte'),
  cteCol: Symbol('cteCol')
};
