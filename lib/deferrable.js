...
inherits(INITIALLY_DEFERRED, ABSTRACT);
...
inherits(INITIALLY_IMMEDIATE, ABSTRACT);
...
inherits(SET_DEFERRED, ABSTRACT);
...
inherits(SET_IMMEDIATE, ABSTRACT);
