 ...
 * ```
 *
 * @property INITIALLY_DEFERRED Allow and enable by default this constraint's checks to be differed at the end of transactions.
 * @property INITIALLY_IMMEDIATE Allow the constraint's checks to be differed at the end of transactions.
 ...
 * @property SET_DEFERRED Defer the deferrable checks involved in this transaction at commit.
 * @property SET_IMMEDIATE Execute the deferrable checks involved in this transaction immediately.
 */
