...
ABSTRACT.prototype.toString = function toString() {
...
INITIALLY_DEFERRED.prototype.toSql = function toSql() {
...
INITIALLY_IMMEDIATE.prototype.toSql = function toSql() {
...
NOT.prototype.toSql = function toSql() {
...
SET_DEFERRED.prototype.toSql = function toSql(queryGenerator) {
...
SET_IMMEDIATE.prototype.toSql = function toSql(queryGenerator) {
  return queryGenerator.setImmediateQuery(this.constraints);
};

for (const key of Object.keys(Deferrable)) {
  const DeferrableType = Deferrable[key];

  DeferrableType.toString = function toString() {
...
module.exports.default = Deferrable;
