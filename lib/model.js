...
module.exports = (function() {
  ...
  /**
   * Truncate the table represented by this Model
   * @param {Object} [options]
   * @param {Boolean} [options.cascade=false] Also truncate objects that depend
   * on this table's rows, such as constrained associations. Only works in postgres
   * @return {Promise}
   */
  Model.prototype.truncate = function(options) {
    return this.QueryInterface.truncateTable(this.getTableName(), options);
  };
