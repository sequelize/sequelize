...
var Model = function(name, attributes, options) {
  if (options.inherits) {
    attributes = _.merge({}, options.inherits.attributes, attributes);
    options = _.merge({}, options.inherits.options, options);
  }
...
Model.prototype.init = function(modelManager) {
  ...
  this.Instance = function() {
    if (this.options && this.options.inherits) {
      this.options.inherits.Instance.apply(this, arguments);
    } else {
  ...
  if (this.options && this.options.inherits) {
    Util.inherits(this.Instance, this.options.inherits.Instance);
  } else {
