...
class Model {
  ...
  _initValues(values, options) {
    ...
    if (options.isNewRecord) {
      ...
      if (
        ...
        this.dataValues[this.constructor._timestampAttributes.createdAt] =
      ...
      if (
        ...
        this.dataValues[this.constructor._timestampAttributes.updatedAt] =
          Utils.toDefaultValue(
            defaults[this.constructor._timestampAttributes.updatedAt],
            this.sequelize.options.dialect
          );
      ...
      if (
        ...
        this.dataValues[this.constructor._timestampAttributes.deletedAt] =
          Utils.toDefaultValue(
            defaults[this.constructor._timestampAttributes.deletedAt],
            this.sequelize.options.dialect
          );
  ...
  static _paranoidClause(model, options = {}) {
    ...
    deletedAtObject[deletedAtAttribute.field || deletedAtCol] =
  ...
  /*
  getAttributes() returns this.rawAttributes
  */
            ...
            .map(async (include) => {
              ...
              if (include.association instanceof BelongsToMany) {
                ...
                const throughInstances =
                  include.association.throughModel.bulkBuild(
                    valueSets,
                    throughOptions
                  );
  ...
  static async destroy(options) {
    ...
    if (this._timestampAttributes.deletedAt && !options.force) {
      ...
      const deletedAtAttribute =
        this.rawAttributes[this._timestampAttributes.deletedAt];
      const field =
        this.rawAttributes[this._timestampAttributes.deletedAt].field;
      const where = {
  ...
  static async restore(options) {
    ...
    attrValueHash[deletedAtAttribute.field || deletedAtCol] =
      deletedAtDefaultValue;
