      ...
      .then(() => {
        ...
        if (options.individualHooks) {
          return this.findAll({
            ...
            .then(found =>
              Promise.all(found.map(instance => this.runHooks('beforeDestroy', instance, options).then(() => instance)))
            )
            .then(_instances => {
              instances = _instances;
            });
      ...
      .then(() => {
        ...
        if (options.individualHooks) {
          return this.findAll({
            ...
            .then(found =>
              Promise.all(found.map(instance => this.runHooks('beforeRestore', instance, options).then(() => instance)))
            )
            .then(_instances => {
              instances = _instances;
            });
          ...
          this._options.include
            ...
            .map(include => {
              ...
              return instance
                .save(includeOptions)
                .then(() =>
                  this[include.association.accessors.set](instance, { save: false, logging: options.logging })
                );
            })
        );
      })
