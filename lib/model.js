...
class Model {
  ...
  _expandIncludeAllElement(includes, include) {
  ...
  _validateIncludedElement(include, tableNames, options) {
  ...
  init(modelManager) {
    ...
    this._addOptionalClassMethods.call();
   ...
   * @return {this}
   */
  schema(schema, options) { // testhint options:none
    var self = this;
   ...
   */
  getTableName(options) { // testhint options:none
   ...
   */
  aggregate(attribute, aggregateFunction, options) {
    options = Utils.cloneDeep(options);
   ...
   * @return {Instance}
   */
  build(values, options) { // testhint options:none
  ...
  bulkBuild(valueSets, options) { // testhint options:none
    options = _.extend({
      isNewRecord: true
    }, options || {});
...
// Aliases
Model.$conformOptions = Model.prototype._conformOptions;
Model.$validateIncludedElements = Model.prototype._validateIncludedElements;
Model.$expandIncludeAll = Model.prototype._expandIncludeAll;
...
Model.prototype.findOrInitialize = Model.prototype.findOrBuild;
