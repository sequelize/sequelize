...
function conformInclude(include, self) {
  ...
  if (_.isString(include)) {
    var as = include;
    include = _.find(self.associations, 'as', include);
    if (! include) throw new Error('Include unexpected. Unable to find Association with \'as\': ' + as);
  }
  ...
  if (include instanceof Association) {
    ...
    if (include.association) {
      ...
      if (! include.model && include.as) {
        var association = _.find(self.associations, 'as', include.as);
        if (! association) throw new Error('Include unexpected. Unable to find Association with \'as\': ' + include.as);
