                ...
                if (!currentAttributes) {
                  ...
                  if (currentAttributes.references) {
                    ...
                    _.each(foreignKeyReferences, foreignKeyReference => {
                      if (!!foreignKeyReference.constraintName
                        ...
                        changes.push(() => this.QueryInterface.removeConstraint(this.getTableName(options), foreignKeyReference.constraintName, options));
                      }
                    });
                  }
