  ...
  static refreshAttributes() {
    ...
    _.each(this.rawAttributes, (definition, name) => {
      ...
      if (definition.type) {
        ...
        if (definition.type.comparator) {
          this._dataTypeComparators[name] = definition.type.comparator;
        }
  ...
  set(key, value, options) { // testhint options:none
    ...
    if (typeof key === 'object' && key !== null) {
      ...
      if (!options.raw && this._customSetters[key]) {
        ...
        if (
          this.constructor._hasDataTypeComparators && this.constructor._dataTypeComparators[key] && this.constructor._dataTypeComparators[key].call(this, key, value, originalValue, options) ||
        ...
        if (this._options && this._options.include && this._options.includeNames.indexOf(key) !== -1) {
          ...
          return this;
        } else if (this.constructor._hasDataTypeComparators && this.constructor._dataTypeComparators[key] && this.constructor._dataTypeComparators[key].call(this, key, value, originalValue, options)) {
