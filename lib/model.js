...
class Model {
  ...
  static _transformStringInclude (include, self) {
  ...
  static _conformInclude(include, self) {
    ...
    include = this._transformStringInclude(include, self)
    ...
    if (include instanceof Association) {
      ...
      if (include.association) {
        ...
        include.association = this._transformStringInclude(include.association, self)
