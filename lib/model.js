...
class Model {
  ...
  static refreshAttributes() {
    ...
    _.each(this.rawAttributes, (definition, name) => {
      ...
      // Mark array enum value for Postgres.
      if (definition.type instanceof DataTypes.ARRAY &&
        DataTypes.ARRAY.is(definition.type, DataTypes.ENUM)) {
        definition.type.enumName = `"${this._schema || 'public'}"${this._schemaDelimiter || '.'}"enum_${this.tableName}_${name}"`;
      }
