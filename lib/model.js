  ...
  */
  Model.prototype.findOne = function(options) {
    if (options !== undefined && !_.isPlainObject(options)) {
      throw new Error('The first argument passed to findOne must be an options object, use findById if you wish to pass a single primary key value');
    }
  ...
  Model.prototype.findOrCreate = function(options) {
    var self = this
      , internalTransaction = !(options && options.transaction)
      , values
      , whereFields
      , defaultFields;
    ...
    return self.sequelize.transaction(options).bind({}).then(function (transaction) {
