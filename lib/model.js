...
class Model {
  ...
  static _paranoidClause(model, options) {
    ...
    deletedAtDefaultValue = deletedAtDefaultValue || { $or: { $gt: this.sequelize.options.dialect === 'mssql' ? model.sequelize.literal('SYSDATETIMEOFFSET()') : model.sequelize.literal('CURRENT_TIMESTAMP'), $eq: null } };
