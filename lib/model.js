...
class Model {
   ...
   *
   *```js
  * Model.increment('number') // increment number by 1
  * Model.increment(['number', 'count'], { by: 2 }) // increment number and count by 2
  * Model.increment({ answer: 42, tries: 1}, { by: 2 }) // increment answer by 42, and tries by 1.
  ...
  */
  static increment(fields, options) {
    ...
    return this.sequelize.getQueryInterface().increment(this, this.getTableName(options), values, where, options).then(affectedRows => {
      if (options.returning) {
        return [affectedRows, affectedRows.length];
      }
  ...
  */
  increment(fields, options) {
    ...
    return this.constructor.increment(fields, options).return(this.reload());
  }
