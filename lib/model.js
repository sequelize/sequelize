...
class Model {
  ...
  static upsert(values, options) {
    ...
    const createdAtAttr = this.rawAttributes[this._timestampAttributes.createdAt].field || this._timestampAttributes.createdAt;
    const updatedAtAttr = this.rawAttributes[this._timestampAttributes.updatedAt].field || this._timestampAttributes.updatedAt;
