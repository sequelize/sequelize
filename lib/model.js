...
class Model {
  ...
  static _findSeparate(results, options) {
    ...
    const includes = options.include.filter(include => {
  ...
  set(key, value, options) {
    ...
    if (!options.raw && this._customSetters[key]) {
      ...
      if (this._options && this._options.include && this._options.includeNames.includes(key) && !this._options.attributes.includes(key)) {
