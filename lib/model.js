...
class Model {
   ...
   * @param  {Boolean|Array<String>} [options.returning=false] Return the affected rows (only for postgres). `true` returns the model's own columns; pass an array of attribute names to return only those
