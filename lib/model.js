...
class Model {
  ...
  static async sync(options) {
    ...
    indexes = _.filter(this.options.indexes, (item1) => !indexes.some((item2) => item1.name === item2.name)).sort(
      (index1, index2) => {
  ...
  static async bulkCreate(records, options) {
    ...
    if (options.updateOnDuplicate) {
      ...
      if (Array.isArray(options.updateOnDuplicate) && !_.isEmpty(options.updateOnDuplicate)) {
