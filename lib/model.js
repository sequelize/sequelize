...
const debug = require('debug')('sequelize:model');
  ...
  set(key, value, options) { // testhint options:none
    ...
    if (typeof key === 'object' && key !== null) {
      ...
      if (
        ...
        (this.isNewRecord || !this.constructor._hasReadOnlyAttributes || this.constructor._hasReadOnlyAttributes && !this.constructor._isReadOnlyAttribute(key)) &&
        this.constructor._hasDataTypeSetters && this.constructor._dataTypeSetters[key]
      ) {
        value = this.constructor._dataTypeSetters[key].call(this, value, key);
      }
      ...
      if (!options.raw && this._customSetters[key]) {
        ...
        if (this._options && this._options.include && this._options.includeNames.indexOf(key) !== -1) {
          ...
          !(value instanceof Utils.SequelizeMethod) &&
          (this.isNewRecord || !this.constructor._hasReadOnlyAttributes || this.constructor._hasReadOnlyAttributes && !this.constructor._isReadOnlyAttribute(key)) &&
          this.constructor._hasDataTypeComparators && this.constructor._dataTypeComparators[key]
        ) {
          if (!options.raw && this.constructor._dataTypeComparators[key].call(this, value, originalValue, key, options)) {
            this._previousDataValues[key] = originalValue;
            this.changed(key, true);
          }
          ...
          if (key === 'birthdate') {
            debug('%O => %O', key, originalValue);
            debug('%O => %O', key, value);
            debug(Utils.isPrimitive(value));
          }
