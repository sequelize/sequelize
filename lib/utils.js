...
var Utils = module.exports = {
  ...
  removeIdentityColumnsFromHash: function(hash, attributes, options) {
    var result = {}
    ...
    Object.keys(hash).forEach(function(attrName) {
      var allowsUpdate = (options.allowUpdate.indexOf(attrName) !== -1)
        , isPrimaryKey = (attributes[attrName] && attributes[attrName].primaryKey)

      if (allowsUpdate || !isPrimaryKey) {
