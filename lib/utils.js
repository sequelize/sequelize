...
var Utils = module.exports = {
  ...
  template: function (template, data) {
    if (!templateStore[template]) {
      // Attention: The variable "data" is used so lodash won't use "with".
      // Otherwise v8 would deoptimize this
      templateStore[template] = lodash.template(template, { variable: 'data' });
    }
    return templateStore[template](data);
  }
};
