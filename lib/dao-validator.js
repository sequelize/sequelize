...
var validateAttributes = function() {
  ...
  Utils._.each(this.model.dataValues, function(value, field) {
    ...
    // it may set a bypass for nested JSON
    var rawAttribute   = self.model.rawAttributes[field];
    // if field has validators
    var hasAllowedNull = ((rawAttribute === undefined || rawAttribute.allowNull === true) && ((value === null) || (value === undefined) || ((typeof rawAttribute.defaultValue != 'undefined') && rawAttribute.defaultValue === value)))
