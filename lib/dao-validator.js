...
function extendValidator(modelInstance){
  ...
  Validator.extend('isImmutable', function(str, param, field) {
    ...
    return modelInstance.dataValues[field] === modelInstance._previousDataValues[field];
  })
}
