...
class InstanceValidator {
  ...
  _perAttributeValidators() {
    ...
    Utils.forEach(this.modelInstance.rawAttributes, (rawAttribute, field) => {
  ...
  _customValidators() {
    const validators = [];
    Utils.forEach(this.modelInstance._modelOptions.validate, (validator, validatorType) => {
  ...
  _singleAttrValidate(value, field, allowNull) {
    ...
    const validators = [];
    Utils.forEach(this.modelInstance.validators[field], (test, validatorType) => {
