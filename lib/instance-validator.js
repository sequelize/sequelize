...
class InstanceValidator {
  ...
  _validate() {
    ...
    return Promise.allSettled([this._builtinValidators(), this._customValidators()]).then(() => {
    ...
    return runHooks('beforeValidate', this.modelInstance, this.options)
      .then(() =>
        this._validate().catch(error =>
          runHooks('validationFailed', this.modelInstance, this.options, error).then(newError => {
  ...
  _customValidators() {
    ...
    _.each(this.modelInstance._modelOptions.validate, (validator, validatorType) => {
      ...
      validators.push(this._invokeCustomValidator(validator, validatorType));
    });
  ...
  _builtinAttrValidate(value, field) {
    ...
    return Promise.allSettled(validators).then(results => this._handleReflectedResult(field, value, results));
  }
  ...
  _invokeCustomValidator(validator, validatorType, optAttrDefined, optValue, optField) {
    ...
    if (isAsync) {
      ...
      return Promise.resolve()
        .then(() => validator.call(this.modelInstance, invokeArgs))
