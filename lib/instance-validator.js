...
import { tryFn } from './utils/promise-helpers.js';
import * as sequelizeError from './errors.js';
...
export class InstanceValidator {
  ...
  _builtinValidators() {
    ...
    for (const field in this.modelInstance.rawAttributes) {
      ...
      if (Object.hasOwn(this.modelInstance.validators, field)) {
   ...
   *
   * @param {Function} validatorFn The custom validator.
