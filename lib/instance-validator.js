...
class InstanceValidator {
  ...
  _customValidators() {
    const validators = [];
    _.each(this.modelInstance._modelOptions.validate, (validatorFn, validatorType) => {
      if (this.options.skip.indexOf(validatorType) >= 0) {
        return;
      }

      validators.push(this._invokeCustomValidator(validatorFn, validatorType));
    });
  ...
  async _builtinAttrValidate(value, field) {
    ...
    _.forIn(this.modelInstance.validators[field], (test, validatorType) => {
      ...
      if (typeof test === 'function') {
        return validators.push(this._invokeCustomValidator(test, validatorType, true, value, field));
      }
