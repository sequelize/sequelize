...
const sanitizeHtmlRaw = require('sanitize-html');
const Utils = require('./utils');

function sanitizeHtml(str) {
  return sanitizeHtmlRaw(str, {
    allowedTags: [],
    allowedAttributes: {}
  });
}
...
STRING.prototype._sanitize = function _sanitize(value) {
...
CHAR.prototype._sanitize = function _sanitize(value) {
  return sanitizeHtml(value);
};
...
TEXT.prototype._sanitize = function _sanitize(value) {
  return sanitizeHtml(value);
};
...
JSONTYPE.prototype._isChanged = function _isChanged(value, originalValue) {
