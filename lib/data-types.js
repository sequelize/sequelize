...
DATE.prototype._sanitize = function _sanitize(value, options) {
  if (!options.raw && !(value instanceof Date) && !!value) {
...
DATE.prototype._isChanged = function _isChanged(value, originalValue) {
  if (originalValue && !!value && value instanceof Date && originalValue instanceof Date && value.getTime() === originalValue.getTime()) {
    return false;
  }
