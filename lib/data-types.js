...
/**
 * Geometry types are used to store {@link http://geojson.org/|GeoJson} which can then be used alongside postgis.
 * Only available in postgres.
 * ```js
 * location: DataTypes.GEOMETRY(type=POLYGON|POINT|ETC, SRID=int)
 * ```
 * @property GEOMETRY
 */
