...
BOOLEAN.prototype.set = function set(value) {
...
DATE.prototype.compare = function compare(value, originalValue) {
  if (originalValue && !!value && value.getTime() === originalValue.getTime()) {
    return false;
  }
...
DATEONLY.prototype.compare = function compare(value, originalValue) {
  if (!!value) {
