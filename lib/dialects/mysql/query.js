  ...
  formatError(err) {
    ...
    switch (errCode) {
      ...
      case 1452: {
        ...
        // TODO: it is not clear whether `table` & `fields` is meant refer to the source or the referenced entity,
        //       ideally you would want to name both, no?

        return new sequelizeErrors.ForeignKeyConstraintError({
          reltype: errCode + '' === '1451' ? 'parent' : 'child',
