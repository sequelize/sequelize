...
module.exports = (function() {
  var QueryGenerator = {
    ...
    bulkInsertQuery: function(tableName, attrValueHashes, options) {
      ...
      if (options && options.fieldsOnDuplicateKey instanceof Array && options.fieldsOnDuplicateKey.length) {
        onDuplicateKeyUpdate += ' ON DUPLICATE KEY UPDATE ' + options.fieldsOnDuplicateKey.map(function(attr) {
