...
module.exports = (function() {
  var QueryGenerator = {
    ...
    updateQuery: function(tableName, values, where) {
      ...
      Utils._.each(values.__factory.rawAttributes, function(value, key){
		value = values[key]
        vals.push(Utils.addTicks(key) + "=" + Utils.escape((value instanceof Date) ? Utils.toSqlDate(value) : value))
      })
