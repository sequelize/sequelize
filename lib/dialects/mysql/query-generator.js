...
const QueryGenerator = {
  ...
  showConstraintsQuery(tableName, constraintName) {
    let sql =  `SELECT CONSTRAINT_CATALOG AS constraint_catalog, CONSTRAINT_NAME AS constraint_name, CONSTRAINT_SCHEMA AS constraint_schema, CONSTRAINT_TYPE AS constraint_type, TABLE_NAME AS table_name, TABLE_SCHEMA AS table_schema from INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE table_name='${tableName}'`;
    if (constraintName) {
