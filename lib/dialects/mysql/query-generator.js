...
const QueryGenerator = {
  ...
  attributeToSQL(attribute, options) {
    ...
    if (attributeString !== 'BLOB' && attributeString !== 'TEXT' && attributeString !== 'GEOMETRY' && attributeString !== 'JSON' && attribute.type._binary !== true && Utils.defaultValueSchemable(attribute.defaultValue)) {
