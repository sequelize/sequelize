...
module.exports = (function() {
  var QueryGenerator = {
    ...
    selectQuery: function(tableName, options) {
      ...
      if (options.include) {
        var optAttributes = options.attributes === '*' ? [options.table + '.*'] : false
        ...
        options.include.forEach(function(include) {
          ...
          optAttributes && ( optAttributes = optAttributes.concat(attributes) )
        ...
        optAttributes && ( options.attributes = optAttributes.join(', ') )
      }
