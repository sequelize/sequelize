...
var QueryGenerator = {
  ...
  /**
   * Generates an SQL query that adds a foreign key to a table.
   * 
   * @param  {String} targetTableName     The name of the table to constrain
   * @param  {String} targetColumnName    The name of the column to constrain
   * @param  {String} foreignKeyName      The name of the foreign key
   * @param  {String} referenceTableName  The name of the table to reference
   * @param  {String} referenceColumnName The name of the column to reference
   * @return {String}                     The generated sql query.
   */
  addForeignKeyQuery: function(targetTableName, targetColumnName, foreignKeyName,
    referenceTableName, referenceColumnName) {
    
    return "ALTER TABLE " + this.quoteTable(targetTableName) + " " +
      "ADD CONSTRAINT " + this.quoteIdentifier(foreignKeyName) + " " +
      "FOREIGN KEY (" + this.quoteIdentifier(targetColumnName) + ") " +
      "REFERENCES " + this.quoteTable(targetTableName) + "(" + this.quoteIdentifier(targetColumnName) + ");"
  },
