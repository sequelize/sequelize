module.exports = (function() {
  var QueryGenerator = {
    ...
    */
    ...
    /*
      ...
      Parameters:
        - tableName -> Name of the table
      Options:
        - optimize -> boolean - whether to use an optimized mechanism (i.e. TRUNCATE) if available,
    ...
    */
    deleteAllQuery: function(tableName, options) {
      throwMethodUndefined('deleteAllQuery')
    },
