...
const QueryGenerator = {
  ...
  */
  ...
  whereItemQuery(key, value, options) {
    ...
    if (!value) {
      return this._joinKeyValue(key, this.escape(value, field), (typeof value === 'undefined' || value === null) ? this.OperatorMap[Op.is] : this.OperatorMap[Op.eq], options.prefix);
    }
  ...
  _whereParseSingleValueObject (key, field, prop, value, options) {
    ...
    if ((typeof value === 'undefined' || value === null) && comparator === this.OperatorMap[Op.eq]) {
      return this._joinKeyValue(key, this.escape(value, field, escapeOptions), this.OperatorMap[Op.is], options.prefix);
    } else if ((typeof value === 'undefined' || value === null) && this.OperatorMap[Op.ne]) {
