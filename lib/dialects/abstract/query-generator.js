    ...
    if (Array.isArray(options.order)) {
      for (const order of options.order) {
        if (Array.isArray(order) && _.size(order) > 1) {
          if (_.isFunction(order[0]) && order[0].prototype instanceof Model || _.isFunction(order[0].model) && order[0].model.prototype instanceof Model) {
        ...
        if (subQuery && (Array.isArray(order) && !(_.isFunction(order[0]) && order[0].prototype instanceof Model) && !(order[0] && _.isFunction(order[0].model) && order[0].model.prototype instanceof Model))) {
