  ...
  generateInclude(include, parentTableName, topLevelInfo) {
    ...
    if (include.through) {
      ...
      if (topLevelInfo.subQuery && include.subQueryFilter) {
        ...
        associationWhere[association.identifierField] = this.sequelize.literal(`${this.quoteTable(parentTableName.internalAs)}.${this.quoteIdentifier(association.sourceKeyField || association.source.primaryKeyField)}`);
