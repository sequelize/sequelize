    ...
    if (typeof collection === 'string'){
      ...
      collection.forEach((item, index) => {
        ...
        if (previousModel && previousModel.prototype instanceof Model) {
          ...
          if (model) {
            ...
            if (!(item instanceof Association)) {
              // item = new Association(previousModel, model, {as});
              throw new Error('Error unable to find a valid association for model.');
            }
          }
        }
        ...
        if (typeof item === 'string') {
          ...
          } else if (previousModel && previousModel.prototype instanceof Model && previousModel.associations !== undefined && previousModel.associations[item]) {
            // convert the item to an association
            item = previousModel.associations[item];
          } else if (previousModel && previousModel.prototype instanceof Model && previousModel.rawAttributes !== undefined && previousModel.rawAttributes[item] && item !== previousModel.rawAttributes[item].field) {
      ...
      collection.forEach((collectionItem) => {
        if (collectionItem instanceof Utils.SequelizeMethod) {
          ...
          sql += this.quoteTable(collectionItem.Model.name) + '.' + collectionItem.fieldName;
