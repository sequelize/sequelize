...
var QueryGenerator = {
  ...
  */
  ...
  selectQuery: function(tableName, options, model) {
    ...
    if (subQuery) {
      subQueryItems.push(this.selectSqlFragmentBuilder(options, subQueryAttributes, table));
      if (mainTableAs) {
    ...
    // Else do it the reguar way
      ...
      if (options.groupedLimit) {
        ...
        mainQueryItems.push(this.selectSqlFragmentBuilder(options, mainAttributes, '('+
        ...
        mainQueryItems.push(this.selectSqlFragmentBuilder(options, mainAttributes, table));
      }
      if (mainTableAs) {
  ...
  selectSqlFragmentBuilder: function(options, attributes, tables) {
    return 'SELECT ' + attributes.join(', ') + ' FROM ' + tables;
  },
