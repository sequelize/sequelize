...
const QueryGenerator = {
  ...
  */
  ...
  selectFromTableFragment(options, model, attributes, tables, mainTableAs) {
    ...
    if(mainTableAs) {
      if(this._dialect === 'oracle') {
        //Oracle does not support AS for tables, just use one space, carefull to reserved words
        // if(mainTableAs.toLowerCase() === 'user' || mainTableAs.toLowerCase() === 'group') {
          //user is a reserved word, so we have to quote it
          fragment += ' "' + mainTableAs + '"';
        // } else {
          // fragment += ' ' + mainTableAs;
        // }
