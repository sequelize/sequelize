  ...
  */
  ...
  generateJoin(include, topLevelInfo) {
    ...
    if (association.extraForeignKeys) {
      const extraForeignKeyConditionLeft = `${this.quoteTable(asLeft)}.${this.quoteIdentifier(association.extraForeignKeys.source)}`;
      const extraForeignKeyConditionRight = `${this.quoteTable(asRight)}.${this.quoteIdentifier(association.extraForeignKeys.target)}`;
      joinOn = `(${joinOn} AND ${extraForeignKeyConditionLeft} = ${extraForeignKeyConditionRight})`;
    }
