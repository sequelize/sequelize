...
class QueryGenerator {
  ...
  */
  selectQuery(tableName, options, model) {
    ...
    const subQueryItems = [];
    const subQuery = subQuery = limit && (options.hasIncludeWhere || options.hasIncludeRequired || options.hasMultiAssociation) && options.subQuery !== false && options.doSubQuery === true;
    const attributes = {
