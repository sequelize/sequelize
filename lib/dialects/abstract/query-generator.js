...
const QueryGenerator = {
  ...
  */
  ...
  getQueryOrders(options, model, subQuery) {
    ...
    if (Array.isArray(options.order)) {
    ...
    } else if (typeof options.order === 'function' && options.order instanceof this.sequelize.literal) {
      ...
      throw new Error('Order must be type of \'Array\' or instance of \'Sequelize.literal()\'.');
    }
