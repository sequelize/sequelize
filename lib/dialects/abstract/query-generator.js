...
class QueryGenerator {
  ...
  updateQuery(tableName, attrValueHash, where, options, attributes) {
    ...
    if (!whereOptions.model) {
      // this.whereQuery(where, whereOptions) calls whereItemQuery which needs model.rawAttributes to detect fields and fieldTypes.
      whereOptions.model = {
        rawAttributes: modelAttributeMap
      };
    }
