...
var QueryGenerator = {
  ...
  */
  ...
  selectQuery: function(tableName, options, model) {
    ...
    if (subQuery) {
      var subWhere = this.getWhereConditions(options.where, mainTableAs || tableName, model, options);
      subQueryItems.push(this.selectFromTableFragment(options, model, subQueryAttributes, table, mainTableAs, subWhere));
