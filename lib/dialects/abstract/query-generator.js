...
const QueryGenerator = {
  ...
  */
  ...
  addLimitAndOffset(options, model) {
    ...
    if (existLimitOffset(options.offset) && !existLimitOffset(options.limit)) {
      fragment += ' LIMIT ' + this.escape(options.offset) + ', ' + 10000000000000;
    } else if (existLimitOffset(options.limit)) {
      if (existLimitOffset(options.offset)) {
    ...
    function existLimitOffset(value) {
