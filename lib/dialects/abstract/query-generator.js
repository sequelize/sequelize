  ...
  */
  quote: function(obj, parent, force) {
    if (Utils._.isString(obj)) {
      ...
      return this.quoteTable(obj.constructor.name) + '.' + obj.fieldName;
  ...
  handleSequelizeMethod: function (smth, tableName, factory, options, prepend) {
    ...
    if (smth instanceof Utils.where) {
      ...
      if (smth.attribute._isSequelizeMethod) {
        ...
        key = this.quoteTable(smth.attribute.constructor.name) + '.' + this.quoteIdentifier(smth.attribute.field || smth.attribute.fieldName);
      }
