  ...
  getQueryOrders(options, model, subQuery) {
    ...
    const quoteOrder = order => {
      ...
      if (Array.isArray(order)) {
        ...
        if (attributeIdentifiers.length > 1) {
          ...
          attributeIdentifiers.forEach((identifier, identifierIndex) => {
            ...
            if (identifierIndex === 0 && model.associations[identifier] !== undefined) {
              association = {
                model: model.associations[identifier].target,
                as: model.associations[identifier].as
              };
            } else if (identifier !== attribute && order[previousOrderIndex] !== undefined && order[previousOrderIndex].model !== undefined && order[previousOrderIndex].model.associations[identifier] !== undefined) {
              association = {
        ...
        // set fields
        if (orderModel.rawAttributes !== undefined && orderModel.rawAttributes[attribute] && attribute !== orderModel.rawAttributes[attribute].field) {
