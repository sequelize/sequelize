...
module.exports = (function() {
  ...
  */
  ...
  var handleSelectQuery = function(results) {
    ...
    if (this.options.raw && !!this.tableName && !!this.sequelize.daoFactoryManager.daos) {
      this.sequelize.daoFactoryManager.daos.forEach(function(dao) {
        if (dao.tableName === this.tableName) {
          this.callee = dao
        }
      }.bind(this))
    }

    if ((this.options.raw && !this.tableName) || !this.callee) {
