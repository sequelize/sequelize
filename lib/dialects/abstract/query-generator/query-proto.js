...
SelectProto.partNames = ['attributes', 'from', 'join', 'where', 'group',
...
InsertProto.partNames = ['preQuery', 'flags', 'table', 'ignoreDups', 'attributes',
...
UpdateProto.partNames = ['preQuery', 'flags', 'table', 'output',
