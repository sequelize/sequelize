...
AbstractDialect.prototype.supports = {
  ...
  schemas: false,
  as: true,                         // Should word 'AS' go between tablenames and aliases
  limitwhere: false,                // Does dialect do LIMIT by adding where statements (Oracle does)
  transactions: true,
  migrations: true,
  upserts: true,
  constraints: {
