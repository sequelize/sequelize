...
const debug = Logger.getLogger().debugContext().extend('sql:mssql');
...
class Query extends AbstractQuery {
  ...
  _run(connection, sql, parameters) {
    ...
    // Must be `this.connection` here.
    const complete = this.sequelize.logQuery(this.connection, sql, options, this.sequelize.options.benchmark || options.benchmark, debug);
