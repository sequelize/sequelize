...
class ConnectionManager extends AbstractConnectionManager {
  constructor(dialect, sequelize) {
    ...
    this.ConnectionWithQueue = class ConnectionWithQueue extends this.lib.Connection {
      constructor(options) {
        super(options);
        this.enqueue = pLimit(1);
      }
    };
  }
  ...
  connect(config) {
    ...
    return new Promise((resolve, reject) => {
      const connection = new this.ConnectionWithQueue(connectionConfig);
