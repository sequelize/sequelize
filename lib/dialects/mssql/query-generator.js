...
module.exports = (function() {
  ...
  var QueryGenerator = {
    ...
    /*
     ...
     If you use a string, you have to escape it on your own.
     */
    updateQuery: function(tableName, attrValueHash, where, rawAttributes, attributeDefinition) {
      attrValueHash = Utils.removeNullValuesFromHash(attrValueHash, this.options.omitNull, rawAttributes)
      attrValueHash = Utils.removeIdentityColumnsFromHash(attrValueHash, attributeDefinition)
