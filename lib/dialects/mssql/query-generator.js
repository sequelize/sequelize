    ...
    if (options.limit || options.offset) {
      ...
      if (options.offset || options.limit) {
        if (options.bindParam) {
          fragment += ` OFFSET ${this.format(offset, null, null, options.bindParam)} ROWS`;
        } else {
      ...
      if (options.limit) {
        if (options.bindParam) {
          fragment += ` FETCH NEXT ${this.format(options.limit, null, null, options.bindParam)} ROWS ONLY`;
        } else {
