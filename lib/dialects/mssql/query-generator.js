...
const QueryGenerator = {
  ...
  selectFromTableFragment(options, model, attributes, tables, mainTableAs, where) {
    ...
    const tableHints = ['NOLOCK', 'READUNCOMMITTED', 'UPDLOCK', 'REPEATABLEREAD', 'SERIALIZABLE', 'READCOMMITTED', 'TABLOCK', 'TABLOCKX', 'PAGLOCK', 'ROWLOCK', 'NOWAIT', 'READPAST', 'XLOCK', 'SNAPSHOT', 'NOEXPAND'];
    if (options.tableHint && _.includes(tableHints, options.tableHint)) {
      mainFragment += ` WITH (${options.tableHint})`;
    }
