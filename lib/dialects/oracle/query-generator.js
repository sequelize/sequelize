...
var QueryGenerator = {
  ...
  createTableQuery(tableName, attributes, options) {
    let query = "CREATE TABLE <%= table %> (<%= attributes %>)"
      , primaryKeys = [], foreignKeys = {}, attrStr = [], self = this;
    ...
    let values = {
      ...
      , pkString = primaryKeys.map((pk => { return pk; }).bind(this)).join(', ');
