...
var QueryGenerator = {
  ...
  startTransactionQuery: function(transaction, options) {
    if (options.parent) {
      return 'SAVEPOINT ' + this.quoteIdentifier(transaction.name.substring(1, 29)) + ';';
    }

    return 'SET TRANSACTION NAME ' + this.quoteIdentifier(transaction.name.substring(1, 29)) + ';';
  },
  ...
  setIsolationLevelQuery: function(value) {
    switch (value) {
      case Transaction.ISOLATION_LEVELS.REPEATABLE_READ:
        return '-- Oracle is not able to choose the isolation level REPEATABLE READ.';
