  ...
  class BOOLEAN extends BaseTypes.BOOLEAN {
    ...
    _sanitize(value) {
      if (typeof value === 'string') {
        ...
        // If value is a number we return true if the value is 1
        // We return false if the value is 0
        // Else we return the value as is and let DB raise error for invalid values 
