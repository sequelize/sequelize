  ...
  constructor(dialect, sequelize) {
    ...
    try {
      if (sequelize.config.dialectModulePath) {
        ...
        // this.lib.fetchAsString = [ this.lib.CLOB, this.lib.BLOB ];
      }
    } catch (err) {
          ...
          if (errorCode) {
            switch (errorCode) {
              ...
              case 'ORA-12154':
                ...
                break;
              case 'ORA-12541' : //ORA-12541: TNS:listener does not currently know of service requested in connect descriptor
