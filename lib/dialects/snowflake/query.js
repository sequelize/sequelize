...
class Query extends AbstractQuery {
  ...
  formatResults(data) {
    ...
    if (this.isSelectQuery()) {
      ...
      // snowflake return attribute as all upper case, change it to lower case
      if ( this.options.originalAttributes ) {
        const sfAttrMap = this.options.originalAttributes.reduce( (prev, v) => {
          prev[v.toUpperCase()] = v;
          return prev;
        }, {});
    ...
    if (this.isBulkUpdateQuery() || this.isBulkDeleteQuery()) {
      // TODO: affectedRows is mysql value, need to construct a sf version
