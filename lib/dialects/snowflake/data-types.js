...
/**
 * @typedef {typeof import('../../data-types').DataTypes} DataTypes
 * @typedef {typeof import('../../data-types').DataTypes.ABSTRACT} ABSTRACT
 * @type {(BaseTypes: DataTypes) => Record<any, ABSTRACT>}
 */
