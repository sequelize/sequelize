    ...
    if (typeof collection === 'string') {
      ...
      throw new Error(
        'Unknown structure passed to order / group: ' +
          (collection instanceof Association ? collection.as : util.inspect(collection))
      );
    }
  },
...
https://github.com/sequelize/sequelize/discussions/15694`);
  ...
  */
  getWhereConditions(smth, tableName, factory, options, prepend) {
    ...
    throw new Error(
      `Unsupported where option value: ${util.inspect(smth)}. Please refer to the Sequelize documentation to learn more about which values are accepted as part of the where option.`
    );
  },
