...
https://github.com/sequelize/sequelize/discussions/15694`);
   ...
   */
  /**
   * Returns a query that commits a transaction. A nested transaction commits by releasing its
   * savepoint, so the subtransaction does not stay open for the life of the root transaction.
   *
   * @param  {Object} options An object with options.
   * @return {String}         The generated sql query.
   * @private
