...
var QueryGenerator = {
  ...
  setAutocommitQuery: function(value, options) {
    ...
    // The options param passed when creating the Sequelize instance should include a key "databaseVersion" 
    // with semver compliant value e.g. "9.5.0" (without 'alpha' or 'beta' classifications)
