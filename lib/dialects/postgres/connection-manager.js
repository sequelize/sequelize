...
class ConnectionManager extends AbstractConnectionManager {
  ...
  connect(config) {
    ...
    return new Promise((resolve, reject) => {
      ...
      // This query only works with PostgreSQL 8.3 or above (typarray column
      // was added in 8.3). See https://github.com/sequelize/sequelize/issues/5254
      if (dataTypes.HSTORE.types.postgres.oids.length === 0 &&
          this.sequelize.options.databaseVersion !== 0 && semver.gte(this.sequelize.options.databaseVersion, '8.3.0')) {
