...
ConnectionManager.prototype.connect = function(config) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    // See https://github.com/sequelize/sequelize/issues/3545 and https://github.com/sequelize/sequelize/issues/3829
    if (self.sequelize.config.useStandardConformingStrings) {
