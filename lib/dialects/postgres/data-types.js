...
module.exports = BaseTypes => {
  ...
  DATE.prototype.set = function set(value, key) {
  ...
  DATE.prototype.comparator = function comparator(key, value, originalValue, options) {
    if (!options.raw && !!value && !(value instanceof Utils.SequelizeMethod)) {
      if (!(value instanceof Date) && value !== Infinity && value !== -Infinity) {
        value = new Date(value);
      }
      if (originalValue) {
