...
module.exports = BaseTypes => {
  ...
  DATEONLY.prototype._sanitize = function _sanitize(value, options) {
    if (!options.raw && value !== Infinity && value !== -Infinity) {
      value = BaseTypes.DATEONLY.prototype._sanitize.call(this, value);
    }
  ...
  DATE.prototype._sanitize = function _sanitize(value, options) {
    if (!options.raw && !(value instanceof Date) && !!value && value !== Infinity && value !== -Infinity) {
