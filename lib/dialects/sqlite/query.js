            ...
            resolve(new Promise((resolve, reject) => {
              ...
              function afterExecute(err, results) {
                ...
                if (err) {
                  ...
                  if(query.isUpdateQuery() && query.options.rejectOnNonAffected && metaData.changes < 1){
                    reject( new sequelizeErrors.NoAffectedRowsError('No rows affected by: ' + query.sql) );
                    return ;
                  }
