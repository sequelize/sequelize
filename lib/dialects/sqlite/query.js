...
const debug = Logger.getLogger().debugContext().extend('sql:sqlite');
...
class Query extends AbstractQuery {
  ...
  run(sql, parameters) {
    ...
    const complete = this.sequelize.logQuery(conn, sql, this.options, this.sequelize.options.benchmark || this.options.benchmark, debug);
