...
const QueryGenerator = {
  ...
  // (copied from ../postgres/query-generator.js)
  ...
  handleSequelizeMethod(smth, tableName, factory, options, prepend) {
    if (smth instanceof Utils.Json) {
      ...
      return MySqlQueryGenerator.handleSequelizeMethod.call(this, smth, tableName, factory, options, prepend);
    }
  },
  ...
  whereItemQuery(key, value, options) {
    ...
    if (_.isPlainObject(value) && fieldType instanceof DataTypes.JSON && options.json !== false) {
      ...
      return MySqlQueryGenerator.whereItemQuery.call(this, key, value, options);
    }
  },
