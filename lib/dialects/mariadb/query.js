...
const debug = Logger.getLogger().debugContext().extend('sql:mariadb');
...
class Query extends AbstractQuery {
  ...
  run(sql, parameters) {
    ...
    const complete = this.sequelize.logQuery(connection, sql, this.options, this.sequelize.options.benchmark || this.options.benchmark, debug);

    if (parameters) {
      debug.log('parameters(%j)', parameters);
    }
