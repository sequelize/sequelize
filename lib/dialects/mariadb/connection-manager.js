...
class ConnectionManager extends AbstractConnectionManager {
  ...
  connect(config) {
    ...
    return this.lib.createConnection(connectionConfig)
      .then(connection => {
        ...
        connection.uuid = connection.threadId;
        debug(`connection acquired ${connection.uuid}`);
  ...
  disconnect(connection) {
    ...
    if (!connection.isValid()) {
      debug(`connection ${connection.uuid} tried to disconnect but was already at CLOSED state`);
