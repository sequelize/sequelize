...
module.exports = BaseTypes => {
  ...
  BaseTypes.FLOAT.types.ibmi = ['DECFLOAT']; // TODO: See what this maps to in ODBC
  ...
  for (const num of [FLOAT, DOUBLE, REAL, SMALLINT, INTEGER, BIGINT]) {
