...
module.exports = function (BaseTypes) {
  var warn = BaseTypes.ABSTRACT.warn.bind(undefined, 'http://www.verticaql.org/docs/9.4/static/datatype.html');

  BaseTypes.UUID.types.vertica = {
    oids: [2950],
    array_oids: [2951]
  };

  BaseTypes.JSON.types.vertica = {
    oids: [114],
    array_oids: [199]
  };

  BaseTypes.JSONB.types.vertica = {
    oids: [3802],
    array_oids: [3807]
  };

  BaseTypes.DATEONLY.types.vertica = {
    oids: [1082],
    array_oids: [1182]
  };

  BaseTypes.TIME.types.vertica = {
    oids: [1083],
    array_oids: [1183]
  };
  ...
  // numeric
  BaseTypes.DECIMAL.types.vertica = {
    oids: [1700],
    array_oids: [1231]
  };
  ...
  BaseTypes.STRING.types.vertica = {
    oids: [1043],
    array_oids: [1015]
  };
  ...
  BaseTypes.BOOLEAN.types.vertica = {
    oids: [16],
    array_oids: [1000]
  };
  ...
  // int4
  BaseTypes.INTEGER.types.vertica = {
    oids: [23],
    array_oids: [1007]
  };
  ...
  // int8
  BaseTypes.BIGINT.types.vertica = {
    oids: [20],
    array_oids: [1016]
  };
  ...
  // float8
  BaseTypes.DOUBLE.types.vertica = {
    oids: [701],
    array_oids: [1022]
  };
  ...
  BLOB.prototype.$hexify = function (hex) {
    // bytea hex format http://www.verticaql.org/docs/current/static/datatype-binary.html
      return "E'\\\\x" + hex + "'";
  };

  BaseTypes.BLOB.types.vertica = {
    oids: [17],
    array_oids: [1001]
  };
  ...
  BaseTypes.GEOMETRY.types.vertica = {
    oids: [],
    array_oids: []
  };
  ...
  BaseTypes.GEOGRAPHY.types.vertica = {
    oids: [],
    array_oids: []
  };
  ...
  BaseTypes.HSTORE.types.vertica = {
    oids: [],
    array_oids: []
  };
