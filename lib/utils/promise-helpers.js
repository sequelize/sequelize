...
exports.method = fn => (...args) => Promise.resolve().then(() => fn(...args));
...
const _fulfilled = (value, isPrimitive) => ({
  isFulfilled: () => true,
  isRejected: () => false,
  value: () => value,
  reason: () => undefined,
...
exports.inspectFulfilled = value => _fulfilled(value);
exports.inspectRejected = reason => _rejected(reason);
