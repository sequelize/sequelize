      ...
      if (urlParts.query) {
        ...
        if (options.dialectOptions) {
          ...
          if (urlParts.query.options) {
            ...
            } catch (error) { // eslint-disable-line unicorn/prefer-optional-catch-binding -- esdoc hasn't been updated and doesn't support this. Remove once https://github.com/sequelize/sequelize/pull/13914 is merged
  ...
  async transaction(options, autoCallback) {
    ...
    return Sequelize._clsRun(async () => {
      try {
        ...
        } catch (error_) { // eslint-disable-line unicorn/prefer-optional-catch-binding -- esdoc hasn't been updated and doesn't support this. Remove once https://github.com/sequelize/sequelize/pull/13914 is merged
          // ignore
        }
