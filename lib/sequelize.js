...
if (typeof process != 'undefined'){
  (function(){
    var version_val = function (version) {
      var get_version_intval = function (m, major, minor) {
        return 1000 * (+major) + (+minor);
      };
      return version.replace(/v(\d+)\.(\d+).*/, get_version_intval);
    };
    if (version_val(process.version) < 6) {
