...
class Sequelize {
   ...
   * @param {string}   [options.intervalStyle] Used to SET intervalstyle when connecting to the server. Only effects PostgreSQL. Must be iso_8601 to properly use intervals.
  ...
  constructor(database, username, password, options) {
    ...
    this.config = {
      ...
      intervalStyle: this.options.intervalStyle,
