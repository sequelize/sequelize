...
class Sequelize {
  ...
  constructor(database, username, password, options) {
    ...
    this.options = Object.assign({
      ...
      logging: Utils.deprecatedDefaultLog,
      omitNull: false,
      native: false,
      replication: false,
      ssl: undefined,
    ...
    if (this.options.logging === true) {
      ...
      this.options.logging = Utils.deprecatedDefaultLog;
    }
  ...
  query(sql, options) {
    ...
    options = _.defaults(options, {
      logging: this.options.hasOwnProperty('logging') ? this.options.logging : Utils.deprecatedDefaultLog,
  ...
  log(...args) {
    ...
    if (last && _.isPlainObject(last) && last.hasOwnProperty('logging')) {
      ...
      if (options.logging === Utils.deprecatedDefaultLog) {
    ...
    if (options.logging) {
      if (options.logging === true) {
        logger.deprecate('The logging-option should be either a function or false. Default: console.log');
        console.warn('wut');
        options.logging = Utils.deprecatedDefaultLog;
      }

      // second argument is sql-timings, when benchmarking option enabled
      if ((this.options.benchmark || options.benchmark) && options.logging === Utils.deprecatedDefaultLog) {
