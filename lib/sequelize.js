 ...
 * @param {String}   [options.useStandardConformingStrings=true] A flag to enable 'SET standard_conforming_strings=on;' for postgres. Default is true.
*/
...
var Sequelize = function(database, username, password, options) {
  ...
  if (this.options.dialect === 'postgres') {
    this.options.useStandardConformingStrings = (this.options.useStandardConformingStrings !== false);
  }
  ...
  this.config = {
    ...
    useStandardConformingStrings: this.options.useStandardConformingStrings,
