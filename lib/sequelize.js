...
module.exports = (function() {
  ...
  */
  ...
  /**
   * Truncate all tables defined through the sequelize instance. This is done
   * by calling Model.delete({ truncate: true }) on each model.
   * @see {Model#delete} for more information
   *
   * @return {Promise}
   */
  Sequelize.prototype.truncate = function() {
    return Promise.all(this.modelManager.daos.map(function(dao) {
      return dao.destroy({}, { truncate: true });
    }));
  };
