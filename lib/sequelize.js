...
class Sequelize {
  ...
  /**
   * Creates a object representing a model attribute's defenition
   *
   * @method attribute
   *
   * @param {DataTypes|Object} attribute Either a data type or attribute definition.
   *
   * @since v4.0.0-2
   * @memberof Sequelize
   * @return {Sequelize.fn}
  ...
  static attribute(attr) {
    return new Utils.Attribute(attr);
  }
  ...
  normalizeAttribute(attribute) {
    if (!(attribute instanceof Utils.Attribute)) {
      attribute = new Utils.Attribute(attribute);
    }
...
// Aliases
Sequelize.prototype.attribute = Sequelize.attribute;
