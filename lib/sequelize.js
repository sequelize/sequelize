...
module.exports = (function() {
   ...
   * @param {String}   [options.environment='development'] Current environment. If not specified - gets environment from NODE_ENV. Used to prevent some destructive operations in production environment.
  ...
  Sequelize.prototype.sync = function(options) {
    ...
    if (options.force) {
      if (this.config.environment === 'production') {
        throw new Error('.sync({ force: true }) is not allowed in production environment.');
      }
