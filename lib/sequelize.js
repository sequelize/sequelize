...
class Sequelize {
   ...
   * @param {Object}   [options.operators] String aliases for operators if not set all aliases are enabled by default.
   *
   */
  constructor(database, username, password, options) {
    ...
    if (this.options.operators === true) {
      ...
      this.dialect.QueryGenerator.setOperatorsAliases(this.options.operators);
    }
