...
import { CLSNamespace } from './cls.js';
...
export class Sequelize {
  ...
  async transaction(options, autoCallback) {
    ...
    if (Sequelize._cls && (!options || options.transaction === undefined)) {
      options = Object.assign({}, options, { transaction: Sequelize._cls.get('transaction') });
    }
