  ...
  */
  ...
  Sequelize.prototype.define = function(daoName, attributes, options) {
    ...
    if(this.options.define) {
      _options = Sequelize.Utils.merge(options, this.options.define)
      if(this.options.define.classMethods) {
        _options.classMethods = Sequelize.Utils.merge(options.classMethods, this.options.define.classMethods)
      }
      if(this.options.define.instanceMethods) {
        _options.instanceMethods = Sequelize.Utils.merge(options.instanceMethods, this.options.define.instanceMethods)
      }
      options = _options;
    }
