...
class Sequelize {
   ...
   * @param {Boolean}  [options.allowLegacyOperators=true] Use Legacy operators. Warning will be deprecated in future versions.
   *
   */
  constructor(database, username, password, options) {
    ...
    if (this.options.operatorsAliases) {
      ...
      this.dialect.QueryGenerator.setOperatorsAliases(Operators.LegacyAliases); //Operators.LegacyAliases should be removed and replaced by Operators.Aliases by v5.0 use
    }
   ...
   */
  static and() {
    return { [Operators.and]: Utils.sliceArgs(arguments) };
  }
   ...
   */
  static or() {
    return { [Operators.or]: Utils.sliceArgs(arguments) };
  }
