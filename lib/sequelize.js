...
class Sequelize {
   ...
   *   // currently supported: 'mysql', 'sqlite', 'postgres', 'mssql' or a custom dialect class
   *   dialect: 'mysql',
   *
   ...
   * @param {string|object} [options.dialect] The dialect of the database you are connecting to. One of mysql, postgres, sqlite, mariadb and mssql, or a custom dialect class.
   ...
   *
   * @returns {string|class} The specified dialect.
   */
  getDialect() {
