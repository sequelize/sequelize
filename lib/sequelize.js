...
var Sequelize = function(database, username, password, options) {
  ...
  this.config = {
    ...
    externalAuth : this.options.externalAuth,
  ...
  switch (this.getDialect()){
    ...
    case 'sqlite':
      ...
      break;
    default:
      throw new Error('The dialect ' + this.getDialect() + ' is not supported. Supported dialects: mariadb, mssql, mysql, oracle, postgres, and sqlite.');
  }
