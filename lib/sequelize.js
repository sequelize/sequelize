...
class Sequelize {
   ...
   *   // currently supported: 'mysql', 'sqlite', 'postgres', 'mssql' or a custom dialect object
   *   dialect: 'mysql',
   *
   ...
   * @param {string|object} [options.dialect] The dialect of the database you are connecting to. One of mysql, postgres, sqlite, mariadb and mssql, or a custom dialect object.
  ...
  constructor(database, username, password, options) {
    ...
    const dialectOption = this.getDialect();

    if (typeof dialectOption === 'string') {
      // Requiring the dialect in a switch-case to keep the
      // require calls static. (Browserify fix)
      switch (dialectOption) {
        case 'mariadb':
        ...
        case 'sqlite':
          ...
          break;
        default:
          throw new Error(`The dialect ${dialectOption} is not supported. Supported dialects: mssql, mariadb, mysql, postgres, and sqlite.`);
      }
    } else {
   ...
   *
   * @returns {string|object} The specified dialect.
   */
  getDialect() {
