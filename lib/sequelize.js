...
module.exports = (function() {
   ...
   * @param {String}   [options.environment='develop'] Current environment. If not specified - gets environment from NODE_ENV. Used to prevent some destructive operations in production environment.
