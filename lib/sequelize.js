...
module.exports = (function() {
  ...
  */
  ...
  Sequelize.prototype.define = function(modelName, attributes, options) {
    ...
    // NOTE: originalAttributes & originalOptions are defined 
    //       here below and not in the Model contructor since options
    //       would already be poluted with global options by that point.

   var self = this,
        globalOptions = this.options,
        originalAttributes = Utils._.cloneDeep(attributes),
        originalOptions =  Utils._.cloneDeep(options);
    ...
    // preserve original options & attributes;
    factory.originalAttributes = originalAttributes;
    factory.originalOptions = originalOptions;
