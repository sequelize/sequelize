...
const hookTypes = {
  ...
  beforeHasOneAssociate: {params: 2, sync: true},
  afterHasOneAssociate: {params: 1, sync: true},
  beforeBelongsToAssociate: {params: 2, sync: true},
  afterBelongsToAssociate: {params: 1, sync: true},
  beforeHasManyAssociate: {params: 2, sync: true},
  afterHasManyAssociate: {params: 1, sync: true},
  beforeBelongsToManyAssociate: {params: 2, sync: true},
  afterBelongsToManyAssociate: {params: 1, sync: true},
