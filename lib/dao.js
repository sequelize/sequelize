...
module.exports = (function() {
  ...
  DAO.prototype.save = function(fields, cb) {
  ...
  DAO.prototype.updateAttributes = function(updates, fields, cb) {
    this.setAttributes(updates)
    return this.save(fields, cb)
  }
  ...
  DAO.prototype.destroy = function(cb) {
    if (this.__options.timestamps && this.__options.paranoid) {
      ...
      var identifier = this.__options.hasPrimaryKeys ? this.primaryKeyValues : this.id
      return this.QueryInterface.delete(this, this.__factory.tableName, identifier).done(cb)
    }
  }

  DAO.prototype.increment = function(fields, count, cb) {
    var identifier = this.__options.hasPrimaryKeys ? this.primaryKeyValues : this.id,
      values = {}
    ...
    return this.QueryInterface.increment(this, this.__factory.tableName, values, identifier).done(cb)
  }

  DAO.prototype.decrement = function (fields, count, cb) {
    if (typeof count === 'function') {
      cb = count
      count = 1
    }
    ...
    return this.increment(fields, 0 - count, cb)
  }
