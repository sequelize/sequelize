...
module.exports = (function() {
  ...
  DAO.prototype.save = function(fieldsOrOptions, options) {
    ...
    }, self.__sequelizeOptions.continuationLocationStorageNamespace).run();
  }
  ...
  */
  DAO.prototype.reload = function(options) {
    ...
    }.bind(this), self.__sequelizeOptions.continuationLocationStorageNamespace).run()
  }
  ...
  DAO.prototype.validate = function(object) {
    var self = this
    var validator = new DaoValidator(this, object, self.__sequelizeOptions)
