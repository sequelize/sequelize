...
module.exports = (function() {
   ...
   * 
   * DAO instances operate with the concept of a `dataValues` property, which stores the actual values represented by the instance. By default, the values from dataValues can also be accessed directly from the DAO, that is:
   * ```js
   * instance.field
   * // is the same as
   * instance.get('field')
   ...
   * @return {Object} The values of the primary keys for this DAO
   */
   ...
   *
   * @return {EventEmitter}                     Fires `success`, `error` and `sql`. On success, the callback will be called with this instance. On validation error, the callback will be called with an Error instance. This error will have a property for each of the fields for which validation failed, with the error message for that field.
   */
  ...
  */
  ...
  /** 
   * Update multiple attributes at once. The values are updated by calling set for each `key, value` pair of the updates object.
   *
   * @see {DAO#set}
