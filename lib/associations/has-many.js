...
module.exports = (function() {
  var HasMany = function(source, target, options) {
    ...
    this.continuationLocalStorageEnabled      = this.source.daoFactoryManager.sequelize.options.continuationLocalStorageEnabled
    this.continuationLocationStorageNamespace = this.source.daoFactoryManager.sequelize.options.continuationLocationStorageNamespace
  }
  ...
  HasMany.prototype.injectGetter = function(obj) {
    ...
    obj[this.accessors.hasAll] = function(objects, options) {
      var instance = this;
      return new Utils.CustomEventEmitter(function(customEventEmitter) {
      ...
      }, self.continuationLocationStorageNamespace).run()
    }
