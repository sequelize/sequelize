...
class HasMany extends Association {
  ...
  async add(sourceInstance, targetInstances, options = {}) {
    ...
    targetInstances = await this.toInstanceCreate(targetInstances);
