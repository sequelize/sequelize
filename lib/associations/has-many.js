...
module.exports = (function() {
  ...
  HasMany.prototype.injectGetter = function(obj) {
    ...
    obj[this.accessors.get] = function(options, cb) {
      ...
      return new Class(self, this).injectGetter(options).done(cb)
    }

    obj[this.accessors.hasAll] = function(objects, cb) {
      var instance = this;
      ...
      return customEventEmitter.run().done(cb)
    }

    obj[this.accessors.hasSingle] = function(o, cb) {
    var instance = this;
      var customEventEmitter = new Utils.CustomEventEmitter(function() {
        instance[self.accessors.get]()
        .error(function(err){ customEventEmitter.emit('error', err)})
  ...
  HasMany.prototype.injectSetter = function(obj) {
    ...
    obj[this.accessors.set] = function(newAssociatedObjects, cb) {
      if (typeof newAssociatedObjects === 'function') {
        cb = newAssociatedObjects
        newAssociatedObjects = undefined
      }
    ...
    obj[this.accessors.add] = function(newAssociatedObject, cb) {
      var instance = this
      return new Utils.CustomEventEmitter(function(emitter) {
    ...
    obj[this.accessors.remove] = function(oldAssociatedObject, cb) {
      var instance = this
      var customEventEmitter = new Utils.CustomEventEmitter(function() {
