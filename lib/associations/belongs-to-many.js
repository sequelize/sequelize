...
var BelongsToMany = function(source, target, options) {
  ...
  this.accessors = {
     ...
     * Get everything currently associated with this and count all rows, using an optional where
     *
     * @param {Object} [options]
     * @param {Object} [options.where] An optional where clause to limit the associated models
     ...
     * @param {String|Boolean} [options.scope] Apply a scope on the related model, or remove its default scope by passing false
     * @return {Promise<Array<Instance>>}
     * @method getAndCountAssociations
     */
...
BelongsToMany.prototype.injectGetter = function(obj) {
  ...
  var get = function(options, method) {
  ...
  obj[this.accessors.get] = get(options);
  obj[this.accessors.getAndCount] = get(options, 'findAndCountAll');
  ...
  obj[this.accessors.getAndCount] = function(options) {
    options = association.target.__optClone(options) || {};
