...
class BelongsToMany extends Association {
  ...
  _injectAttributes() {
    ...
    if (this.through.model.underscored) {
      if (!this.through.model.rawAttributes[this.foreignKey].hasOwnProperty('field')) {
        this.through.model.rawAttributes[this.foreignKey].field = Utils.underscore(this.foreignKey);
      }
      if (!this.through.model.rawAttributes[this.otherKey].hasOwnProperty('field')) {
        this.through.model.rawAttributes[this.otherKey].field = Utils.underscore(this.otherKey);
      }
    }
