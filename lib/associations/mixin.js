 ...
 * ```
 * By default, the name of the join model will be source+target, so in this case projectuser. This can be overridden by providing either a string or a Model as `through` in the options.
 ...
 *   var p1 = projects[0]
 *   p1.userproject.started // Is this project started yet?
 * })
 * ```
 *
 * @param {Model}               target
