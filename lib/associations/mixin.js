...
Mixin.hasOne = function(associatedDAO, options) {
  ...
  var association = new HasOne(this, associatedDAO, Utils._.defaults((options || {}), Utils._.defaults((this.daoFactoryManager.sequelize.options.define || {}), this.options)))
...
Mixin.belongsTo = function(associatedDAO, options) {
  ...
  var association = new BelongsTo(this, associatedDAO, Utils._.defaults((options || {}), Utils._.defaults((this.daoFactoryManager.sequelize.options.define || {}), this.options)))
  this.associations[association.associationAccessor] = association.injectAttributes()
...
Mixin.hasMany = function(associatedDAO, options) {
  ...
  var association = new HasMany(this, associatedDAO, Utils._.defaults((options || {}), Utils._.defaults((this.daoFactoryManager.sequelize.options.define || {}), this.options)))
  this.associations[association.associationAccessor] = association.injectAttributes()
