...
module.exports = (function() {
  ...
  BelongsTo.prototype.injectGetter = function(obj) {
    var self     = this
      , fnName = 'get_' + (this.options.as || Utils.singularize(this.target.tableName, this.target.options.language))
      , underscored = this.options.as ? this.options.underscored : this.target.options.underscored
      , accessor = underscored ? fnName : Utils._.camelize(fnName)
  ...
  BelongsTo.prototype.injectSetter = function(obj) {
    var self     = this
      , fnName = 'set_' + (this.options.as || Utils.singularize(this.target.tableName, this.target.options.language))
      , underscored = this.options.as ? this.options.underscored : this.target.options.underscored
      , accessor = underscored ? fnName : Utils._.camelize(fnName)
