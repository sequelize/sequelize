...
BelongsTo.prototype.injectAttributes = function() {
  ...
  if (this.options.constraints !== false) {
    ...
    // On Oracle, ON DELETE NO ACTION is default behavior, and cannot be explicitly set.
    if (this.options.sequelize.options.dialect === 'oracle' && !source.allowNull) this.options.onDelete = null;
