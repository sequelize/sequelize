...
module.exports = (function() {
  ...
  BelongsTo.prototype.injectGetter = function(obj) {
    ...
    obj[accessor] = function(params, cb) {
      ...
      return self.target.find(params).done(cb)
    }
  ...
  BelongsTo.prototype.injectSetter = function(obj) {
    ...
    obj[accessor] = function(associatedObject, cb) {
      if (typeof associatedObject === 'function') {
        cb = associatedObject
      ...
      return this.save([ self.identifier ]).done(cb)
    }
