...
/**
 * Thrown when query cannot be executed because a Sequelize transaction did not exist, and
 * noImplicitTransactions is enabled.
 * @extends BaseError
 * @memberof Errors
 */
class NoTransactionError extends BaseError {
  constructor(message) {
    super(message);
