 ...
 * @constructor
 */
error.OptimisticLockError = function(options) {
  options = options || {};
  options.message = options.message || 'Attempting to update a stale model instance: ' + options.model;
  error.BaseError.call(this, options.message);
  this.name = 'OptimisticLockError';
  this.values = options.values;
  this.where = options.where;
  this.message = options.message;
};
util.inherits(error.OptimisticLockError, error.BaseError);
