...
Transaction.prototype.cleanup = function() {
  ...
  this.unbindAllInstances();
  return this.sequelize.connectionManager.releaseConnection(this.connection);
};

Transaction.prototype.bindInstance = function ( instance ) {
  var i = this.instances.indexOf( instance );
...
Transaction.prototype.unbindInstance = function ( instance ) {
  var i = this.instances.indexOf( instance );
...
Transaction.prototype.unbindAllInstances = function () {
  Utils._.each( this._instances, function ( instance ) {
    delete instance.options.transaction;
  });
};