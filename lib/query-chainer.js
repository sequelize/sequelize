...
module.exports = (function() {
  var QueryChainer = function(emitters, sequelizeOptions) {
    var self = this
    ...
    this.__sequelizeOptions = sequelizeOptions ? sequelizeOptions : {}
  ...
  QueryChainer.prototype.run = function() {
    ...
    }, self.__sequelizeOptions.continuationLocationStorageNamespace)
  ...
  QueryChainer.prototype.runSerially = function(options) {
    ...
    this.eventEmitter = new Utils.CustomEventEmitter(exec, self.__sequelizeOptions.continuationLocationStorageNamespace)
    return this.eventEmitter.run()
  }
