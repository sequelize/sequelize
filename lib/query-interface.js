...
module.exports = (function() {
  ...
  **/
  ...
  QueryInterface.prototype.truncateTable = function(tableName, options) {
    options = options || {};
    options.cascade = options.cascade || options.force || false;

    var sql = this.QueryGenerator.truncateTableQuery(tableName, options);

    // Don't have to worry about dropping enums, we're just clearing rows.
