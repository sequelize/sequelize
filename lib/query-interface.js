...
module.exports = (function() {
  var QueryInterface = function(sequelize) {
    ...
    this.QueryGenerator         = typeof  this.sequelize.options.dialect  === 'string'
        ?require('./dialects/' + this.sequelize.options.dialect + '/query-generator')
        :  this.sequelize.options.dialect.QueryGenerator;
