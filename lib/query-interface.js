...
module.exports = (function() {
  ...
  QueryInterface.prototype.deleteAll = function(dao, tableName, options) {
    var sql = this.QueryGenerator.deleteAllQuery(tableName, options)
    return queryAndEmit.call(this, [sql, dao], 'deleteAll')
  }
