...
const MariaDBQueryInterface = require('./dialects/mariadb/query-interface');
...
class QueryInterface {
  ...
  removeColumn(tableName, attributeName, options) {
    ...
    switch (this.sequelize.options.dialect) {
      ...
      case 'mariadb':
        ...
        return MariaDBQueryInterface.removeColumn.call(this, tableName, attributeName, options);
      default:
  ...
  removeConstraint(tableName, constraintName, options) {
    ...
    switch (this.sequelize.options.dialect) {
      ...
      case 'mariadb':
        return MariaDBQueryInterface.removeConstraint.call(this, tableName, constraintName, options);
      case 'sqlite':
