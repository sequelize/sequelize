...
module.exports = (function() {
  ...
  QueryInterface.prototype.showReferences = function(tableName, options) {
    var self = this
    ...
    return new Utils.CustomEventEmitter(function(emitter) {
      var sql = self.QueryGenerator.showReferencesQuery(tableName, options)
  ...
  QueryInterface.prototype.select = function(factory, tableName, options, queryOptions) {
    ...
    queryOptions = Utils._.extend({}, queryOptions, { include: options.include, hasJoin: options.hasJoin })
