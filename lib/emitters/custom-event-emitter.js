...
var bindToContinuationLocalStorageNamespace = function(clsNamespace, emitter) {
    if(!!clsNamespace){
...
module.exports = (function() {
  var CustomEventEmitter = function(fct, clsNamespace) {
    this.fct = bindToProcess(fct)

    this.clsNamespace = bindToContinuationLocalStorageNamespace(clsNamespace, this);
  }
