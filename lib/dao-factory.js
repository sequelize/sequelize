...
module.exports = (function() {
  ...
  DAOFactory.prototype.findAll = function(options, queryOptions) {
    ...
    if (typeof options === 'object') {
      ['include', 'join'].forEach(function (includeOption) {
        if (options.hasOwnProperty(includeOption)) {
            hasJoin = true
            options[includeOption] = options[includeOption].map(validateIncludedElement.bind(this))
          }
      }, this)
