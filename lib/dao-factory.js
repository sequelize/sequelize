...
module.exports = (function() {
  ...
  DAOFactory.prototype.init = function(daoFactoryManager) {
    ...
    if (this.options.behaviors) {
      this.options.behaviors.forEach(function(behavior) {
        Utils._.functions(behavior).forEach(function(name) {
          DAOFactory.prototype[name] = behavior[name];
        });
      })
    }
    ...
    var behaviorInitFunctions = [];
    if (this.options.behaviors) {
      this.options.behaviors.forEach(function(behavior) {
        behaviorInitFunctions.push(behavior);
    ...
    this.DAO.prototype.init = function() {
      var self = this;
      behaviorInitFunctions.forEach(function(fct) {
        fct.call(self);
      })
    }
