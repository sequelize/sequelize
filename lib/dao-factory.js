...
module.exports = (function() {
  ...
  DAOFactory.prototype.drop = function(cb) {
    return this.QueryInterface.dropTable(this.tableName).done(cb)
  }

  // alias for findAll
  DAOFactory.prototype.all = function(options, cb) {
    return this.findAll(options, cb)
  }

  DAOFactory.prototype.findAll = function(options, cb) {
  ...
  DAOFactory.prototype.findAllJoin = function(joinTableName, options, cb) {
    if (typeof options === 'function') {
      cb = options
      options = undefined
    }
    ...
    return this.QueryInterface.select(this, [this.tableName, joinTableName], optcpy, { type: 'SELECT' }).done(cb)
  }
  ...
  */
  DAOFactory.prototype.find = function(options, cb) {
    var hasJoin = false
  ...
  DAOFactory.prototype.count = function(options, cb) {
    if (typeof options === 'function') {
      cb = options
      options = undefined
    }
    ...
    return this.QueryInterface.rawSelect(this.tableName, options, 'count').done(cb)
  }

  DAOFactory.prototype.max = function(field, options, cb) {
    if (typeof options === 'function') {
      cb = options
      options = undefined
    }
    ...
    return this.QueryInterface.rawSelect(this.tableName, options, 'max').done(cb)
  }
  DAOFactory.prototype.min = function(field, options, cb) {
    if (typeof options === 'function') {
      cb = options
      options = undefined
    }
    ...
    return this.QueryInterface.rawSelect(this.tableName, options, 'min').done(cb)
  }
  ...
  DAOFactory.prototype.create = function(values, fields, cb) {
    return this.build(values).save(fields, cb)
  }

  DAOFactory.prototype.findOrCreate = function (params, defaults, cb) {
    var self = this;
