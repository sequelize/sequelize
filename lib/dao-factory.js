...
module.exports = (function() {
  ...
  DAOFactory.prototype.deleteAll = function(options) {
    var delFld;

    if (this.options.paranoid) {
      delFld = Utils._.underscoredIf('deletedAt', this.options.underscored);

      return this.QueryInterface.update(this, this.tableName, {delFld : new Date()}, {delFld : null});
    }

    return this.QueryInterface.deleteAll(this, this.tableName, options)
  }
