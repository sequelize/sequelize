...
module.exports = (function() {
  ...
  */
  ...
  var validateIncludedElement = function(include) {
    ...
    else if (include.associationType) {
      include = { daoFactory: include.target, tableName: include.source.tableName, as: include.target.tableName, association: include }
    }
    ...
    if (typeof include === 'object') {
      ...
      if (include.hasOwnProperty('daoFactory') && (include.hasOwnProperty('as'))) {
        var usesAlias   = (include.as !== include.daoFactory.tableName)
          , hasAssociation = include.hasOwnProperty('association')
          , association = hasAssociation ? include.association :
            (usesAlias ? this.getAssociationByAlias(include.as) : this.getAssociation(include.daoFactory))
