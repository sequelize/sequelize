...
ModelDefinition.prototype.build = function(values, options) {
  ...
  Utils._.each(this.options.getterMethods || {}, function(fct, name) { instance.__defineGetter__(name, fct); });
  Utils._.each(this.options.setterMethods || {}, function(fct, name) { instance.__defineSetter__(name, fct); });
