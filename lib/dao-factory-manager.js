...
module.exports = (function() {
  ...
  DAOFactoryManager.prototype.addDAO = function(dao) {
    ...
    var daoFactoryEmit = dao.emit
    dao.emit = function() { 
      var res = daoFactoryEmit.apply(dao, arguments)
      if (Utils._.contains(['preBuild', 'postBuild', 'preSave', 'postSave', 'preDestroy', 'postDestroy'], arguments[0])) {
