...
export const showAllToListSchemas = deprecate(noop, 'Do not use "showAllSchemas". Use Sequelize#listSchemas or QueryInterface#listSchemas instead.', 'SEQUELIZE0024');
export const showAllToListTables = deprecate(noop, 'Do not use "showAllTables". Use Sequelize#listTables or QueryInterface#listTables instead.', 'SEQUELIZE0025');
