...
export interface TemporalTableOptions {
  /**
   * Enables temporal table suport for the model.
   */
  temporalTableType: TemporalTableType;
  ...
  /**
   * Override the name of the application period row start attribute if a string is provided.
  ...
  /**
   * Override the name of the application period row end attribute if a string is provided.
   * {@link temporalTableType} must be APPLICATION_PERIOD or BITEMPORAL.
   *
   * Not affected by underscored setting.
   */
