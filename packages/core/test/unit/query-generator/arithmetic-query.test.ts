...
describe('QueryGenerator#arithmeticQuery', () => {
  ...
  it('uses the specified operator', async () => {
    ...
    expectsql(sqlPlus, {
      ...
      sqlite: 'UPDATE `myTable` SET `foo`=`foo`+ 3 RETURNING *',
  ...
  it('uses the specified operator with literal', async () => {
    ...
    expectsql(sql, {
      ...
      sqlite: 'UPDATE `myTable` SET `foo`=`foo`+ bar RETURNING *',
  ...
  it('supports specifying a WHERE clause', async () => {
    ...
    expectsql(sql, {
      ...
      sqlite: "UPDATE `myTable` SET `foo`=`foo`+ 3 WHERE `bar` = 'biz' RETURNING *",
  ...
  it('does not cause a syntax error when the minus operator is used with a negative value', async () => {
    ...
    expectsql(sql, {
      ...
      sqlite: 'UPDATE `myTable` SET `foo`=`foo`- -1 RETURNING *',
  ...
  it('parses named replacements in literals', async () => {
    ...
    expectsql(sql, {
      ...
      sqlite: "UPDATE `Users` SET `age`=`age`+ 2,`name`='John' WHERE id = 47 RETURNING *",
