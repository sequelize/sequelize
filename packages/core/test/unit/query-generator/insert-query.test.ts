...
describe('QueryGenerator#insertQuery', () => {
  ...
  it('parses named replacements in literals', () => {
    ...
    expectsql(query, {
      ...
      'db2 ibmi': `SELECT * FROM FINAL TABLE (INSERT INTO "Users" ("firstName") VALUES ('Zoe'));`,
    });
  ...
  it('supports named bind parameters in literals', () => {
    ...
    expectsql(query, {
      ...
      'db2 ibmi': `SELECT * FROM FINAL TABLE (INSERT INTO "Users" ("firstName","lastName","username") VALUES ($sequelize_1,$lastName,$sequelize_2));`,
    });
  ...
  it('parses positional bind parameters in literals', () => {
    ...
    expectsql(query, {
      ...
      'db2 ibmi': `SELECT * FROM FINAL TABLE (INSERT INTO "Users" ("firstName","lastName","username") VALUES ($sequelize_1,$1,$sequelize_2));`,
    });
    expect(bind).to.deep.eq({
      sequelize_1: 'John',
      sequelize_2: 'jd',
  ...
  it('parses bind parameters in literals even with bindParams: false', () => {
    ...
    expectsql(query, {
      ...
      'db2 ibmi': `SELECT * FROM FINAL TABLE (INSERT INTO "Users" ("firstName","lastName","username") VALUES ('John',$1,'jd'));`,
    });
  ...
  describe('returning', () => {
    it('supports returning: true', () => {
      ...
      expectsql(query, {
        ...
        postgres: 'INSERT INTO "Users" ("firstName") VALUES ($sequelize_1) RETURNING "id", "firstName";',
