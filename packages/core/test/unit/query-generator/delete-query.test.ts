...
describe('QueryGenerator#deleteQuery', () => {
  ...
  it('parses named replacements in literals', async () => {
    ...
    expectsql(query, {
      ...
      'postgres snowflake': `DELETE FROM "Users" WHERE "id" IN (SELECT "id" FROM "Users" WHERE name = 'Zoe' LIMIT 1)`,
      ...
      'db2 ibmi': `DELETE FROM "Users" WHERE name = 'Zoe' FETCH NEXT 1 ROWS ONLY`,
    });
  });
});
