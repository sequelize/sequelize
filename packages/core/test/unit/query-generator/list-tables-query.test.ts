...
describe('QueryGenerator#listTablesQuery', () => {
  ...
  it('produces a query that lists all tables', () => {
    expectsql(() => queryGenerator.listTablesQuery(), {
      ...
      hana: `SELECT TABLE_NAME AS "tableName", SCHEMA_NAME AS "schema" FROM SYS.TABLES WHERE SCHEMA_NAME != 'SYS' AND SCHEMA_NAME NOT LIKE '_SYS%' AND SCHEMA_NAME NOT IN ('SYS') ORDER BY SCHEMA_NAME, TABLE_NAME`,
    });
  });
  ...
  it('produces a query that lists all tables with a schema', () => {
    expectsql(() => queryGenerator.listTablesQuery({ schema: 'mySchema' }), {
      ...
      hana: `SELECT TABLE_NAME AS "tableName", SCHEMA_NAME AS "schema" FROM SYS.TABLES WHERE SCHEMA_NAME != 'SYS' AND SCHEMA_NAME NOT LIKE '_SYS%' AND SCHEMA_NAME = 'mySchema' ORDER BY SCHEMA_NAME, TABLE_NAME`,
    });
  });
  ...
  it('produces a query that lists all tables with the default schema', () => {
    expectsql(
      () => queryGenerator.listTablesQuery({ schema: sequelize.dialect.getDefaultSchema() }),
      {
        ...
        hana: `SELECT TABLE_NAME AS "tableName", SCHEMA_NAME AS "schema" FROM SYS.TABLES WHERE SCHEMA_NAME != 'SYS' AND SCHEMA_NAME NOT LIKE '_SYS%' AND SCHEMA_NAME = 'SYSTEM' ORDER BY SCHEMA_NAME, TABLE_NAME`,
      },
    );
  });
});
