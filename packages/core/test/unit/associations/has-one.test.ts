...
describe(getTestDialectTeaser('hasOne'), () => {
  ...
  //     });
  //     User.belongsTo(Tenants, { foreignKey: 'tenantId' });
  //
  ...
  //   });
  //
  //   it.only('should add foreign keys', () => {
  //     User.hasOne(Phone, { foreignKeys: ['projectId', 'tenantId'], hooks: false });
  //     expect(Phone.getAttributes().projectId).to.not.be.undefined;
  //     expect(Phone.getAttributes().tenantId).to.not.be.undefined;
  //   });
  //
  //   it('should add not null foreign keys', () => {
  //     User.hasOne(Phone, { foreignKeys: ['projectId', 'tenantId'], hooks: false });
  //     expect(Phone.getAttributes().projectId.allowNull).to.be.false;
  //     expect(Phone.getAttributes().tenantId.allowNull).to.be.false;
  //   });
  // });
});
