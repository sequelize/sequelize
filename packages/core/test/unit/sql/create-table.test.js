...
describe(Support.getTestDialectTeaser('SQL'), () => {
  ...
  describe('createTable', () => {
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            duckdb: 'CREATE SEQUENCE IF NOT EXISTS "foo_users_id_seq" START 1; CREATE TABLE IF NOT EXISTS "foo"."users" ("id" INTEGER NOT NULL DEFAULT nextval(\'foo_users_id_seq\'), "mood" ENUM(\'happy\', \'sad\'), PRIMARY KEY ("id"));'
          },
        );
      });
    });
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            duckdb: 'CREATE SEQUENCE IF NOT EXISTS "bar_projects_id_seq" START 1; CREATE TABLE IF NOT EXISTS "bar"."projects" ("id" INTEGER NOT NULL DEFAULT nextval(\'bar_projects_id_seq\'), "user_id" INTEGER, PRIMARY KEY ("id"));'
          },
        );
      });
    });
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            duckdb:
                'CREATE SEQUENCE IF NOT EXISTS "images_id_seq" START 1; CREATE TABLE IF NOT EXISTS "images" ("id" INTEGER DEFAULT nextval(\'images_id_seq\'), PRIMARY KEY ("id"));',
          },
        );
      });
    });
