  ...
  describe('createTable', () => {
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            ...
            snowflake:
              'CREATE TABLE IF NOT EXISTS "foo"."users" ("id" INTEGER NOT NULL DEFAULT "users_id_seq".NEXTVAL, "mood" VARCHAR(255), PRIMARY KEY ("id"));',
          },
        );
      });
    });
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            ...
            snowflake:
              'CREATE TABLE IF NOT EXISTS "bar"."projects" ("id" INTEGER NOT NULL DEFAULT "projects_id_seq".NEXTVAL, "user_id" INTEGER, PRIMARY KEY ("id"), FOREIGN KEY ("user_id") REFERENCES "bar"."users" ("id") ON DELETE NO ACTION ON UPDATE CASCADE);',
          },
        );
      });
    });
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            ...
            snowflake:
              'CREATE TABLE IF NOT EXISTS "images" ("id" INTEGER DEFAULT "images_id_seq".NEXTVAL, PRIMARY KEY ("id"), FOREIGN KEY ("id") REFERENCES "files" ("id"));',
          },
        );
      });
    });
