...
describe(Support.getTestDialectTeaser('SQL'), () => {
  ...
  describe('createTable', () => {
    const hanaIfNotExistsWrapper = (sql, tableName, schema) => `
      DO BEGIN
        IF NOT EXISTS (
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            ...
            hana: hanaIfNotExistsWrapper(
              'CREATE COLUMN TABLE "foo"."users" ("id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY, "mood" NVARCHAR(255), PRIMARY KEY ("id"));',
              'users',
              'foo',
            ),
          },
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            ...
            hana: hanaIfNotExistsWrapper(
              'CREATE COLUMN TABLE "bar"."projects" ("id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY, "user_id" INTEGER, PRIMARY KEY ("id"), FOREIGN KEY ("user_id") REFERENCES "bar"."users" ("id") ON UPDATE CASCADE);',
              'projects',
              'bar',
            ),
          },
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE VALUE '42710'
      ...
      END`,
            ...
            hana: hanaIfNotExistsWrapper(
              'CREATE COLUMN TABLE "images" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY, PRIMARY KEY ("id"), FOREIGN KEY ("id") REFERENCES "files" ("id"));',
              'images',
              'SYSTEM',
            ),
          },
