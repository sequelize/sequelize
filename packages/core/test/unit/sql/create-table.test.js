  ...
  describe('createTable', () => {
    describe('with enums', () => {
      it('references enum in the right schema #3171', () => {
        ...
        expectsql(sql.createTableQuery(FooUser.table, sql.attributesToSQL(FooUser.getAttributes()), {}), {
    ...
    describe('with references', () => {
      it('references right schema when adding foreign key #9029', () => {
        ...
        expectsql(sql.createTableQuery(BarProject.table, sql.attributesToSQL(BarProject.getAttributes()), {}), {
    ...
    describe('with references on primary key', () => {
      it('references on primary key #9461', () => {
        ...
        expectsql(sql.createTableQuery(Image.table, sql.attributesToSQL(Image.getAttributes()), {}), {
