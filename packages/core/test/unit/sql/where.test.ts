      ...
      describe('DATE', () => {
        ...
        testSql(
          ...
          },
          {
            ...
            'db2 ibmi snowflake hana': `"dateAttr" BETWEEN '2021-01-01 00:00:00.000' AND '2022-01-01 00:00:00.000'`,
        ...
        testSql(
          { dateAttr: { [Op.in]: [new Date('2021-01-01T00:00:00Z')] } },
          {
            ...
            'db2 ibmi snowflake hana': `"dateAttr" IN ('2021-01-01 00:00:00.000')`,
