...
/**
 * Isolated coverage for Tedious bind typing (VarChar vs NVarChar).
 * Kept out of the pre-existing query.test.js suite to avoid training conflicts.
 */
if (dialect === 'mssql') {
  describe('[MSSQL Specific] VARCHAR-safe bind typing', () => {
    let query;
