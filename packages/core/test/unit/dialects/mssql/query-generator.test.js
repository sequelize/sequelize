  ...
  describe('[MSSQL Specific] QueryGenerator', () => {
    ...
    it('upsertQuery with falsey values', function () {
      ...
      expectsql(
        ...
        {
          mssql:
            "MERGE INTO [test_table] WITH(HOLDLOCK) AS [test_table_target] USING (VALUES(24)) AS [test_table_source]([Age]) ON [test_table_target].[Name] = [test_table_source].[Name] AND [test_table_target].[IsOnline] = [test_table_source].[IsOnline] WHEN MATCHED THEN UPDATE SET [test_table_target].[Name] = 'Charlie', [test_table_target].[Age] = 24, [test_table_target].[IsOnline] = 0 WHEN NOT MATCHED THEN INSERT ([Age]) VALUES(24) OUTPUT $action, INSERTED.*;",
        },
      );
    });
    ...
    it('bulkInsertQuery', function () {
      ...
      expectsql(
        ...
        {
          mssql: "INSERT INTO [myTable] ([name]) VALUES ('foo'),('bar');",
        },
      );
      ...
      expectsql(
        ...
        {
          mssql:
            "INSERT INTO [myTable] ([username],[firstName],[lastName]) VALUES ('username','firstName','lastName'),(NULL,'user1FirstName','user1LastName');",
        },
      );
      ...
      expectsql(
        ...
        {
          mssql:
            "INSERT INTO [myTable] ([firstName],[lastName]) VALUES ('firstName','lastName'),('user1FirstName','user1LastName');",
        },
      );
    ...
    it('addColumnQuery preserves Unicode comments', function () {
      expectsql(
        this.queryGenerator.addColumnQuery('myTable', 'myColumn', {
          type: 'VARCHAR(255)',
