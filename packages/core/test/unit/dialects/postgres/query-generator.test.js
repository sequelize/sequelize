      ...
      bulkInsertQuery: [
        ...
        },
        {
          arguments: [
            'myTable',
            [{ name: 'foo' }, { name: 'bar' }],
            { returning: true, parameterStyle: ParameterStyle.BIND },
          ],
          expectation: {
            query:
        ...
        },
        {
          arguments: [
            'myTable',
            [{ name: 'foo' }, { name: 'bar' }],
            { returning: ['id', 'sentToId'], parameterStyle: ParameterStyle.BIND },
          ],
          expectation: {
            query:
        ...
        },
        {
          arguments: [
            'myTable',
            [{ name: 'foo' }, { name: 'bar' }],
            { ignoreDuplicates: true, returning: true, parameterStyle: ParameterStyle.BIND },
          ],
          expectation: {
            query:
        ...
        },
        {
          ...
          expectation: {
            query: `INSERT INTO myTable (name,nullValue) VALUES ($sequelize_1,$sequelize_2),($sequelize_3,$sequelize_4);`,
            bind: { sequelize_1: 'foo', sequelize_2: null, sequelize_3: 'bar', sequelize_4: null },
          },
        ...
        },
        {
          ...
          expectation: {
            query: 'INSERT INTO "myTable" ("name") VALUES (\'foo\'),(\'bar\') RETURNING *;',
          },
        },
        {
          arguments: [
        ...
        },
        {
          ...
          expectation: {
            query: 'INSERT INTO "mySchema"."myTable" ("name") VALUES (\'foo\'),(\'bar\');',
          },
        },
        {
          arguments: [
        ...
        },
        {
          ...
          expectation: {
            query: `INSERT INTO myTable (name,nullValue) VALUES ('foo',NULL),('bar',NULL);`,
          },
          context: { options: { quoteIdentifiers: false } },
        },
        {
        ...
        },
        {
          ...
          expectation: { query: `INSERT INTO mySchema.myTable (name) VALUES ('foo'),('bar');` },
          context: { options: { quoteIdentifiers: false } },
        },
        {
          arguments: [
