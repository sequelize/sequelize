      ...
      insertQuery: [
        {
          ...
          expectation: {
            query:
              'SELECT * FROM FINAL TABLE (INSERT INTO "myTable" ("name") VALUES ($sequelize_1));',
        ...
        },
        {
          ...
          expectation: {
            query:
              'SELECT * FROM FINAL TABLE (INSERT INTO "myTable" ("name","foo") VALUES ($sequelize_1,$sequelize_2));',
        ...
        },
        {
          ...
          expectation: {
            query:
              'SELECT * FROM FINAL TABLE (INSERT INTO "myTable" ("data") VALUES ($sequelize_1));',
        ...
        },
        {
          ...
          expectation: {
            query:
              'SELECT * FROM FINAL TABLE (INSERT INTO "myTable" ("name","foo","nullValue") VALUES ($sequelize_1,$sequelize_2,$sequelize_3));',
    ...
    each(suites, (tests, suiteTitle) => {
      describe(suiteTitle, () => {
        for (const test of tests) {
          ...
          const title =
            test.title || `Db2 correctly returns ${query} for ${JSON.stringify(test.arguments)}`;
          it(title, () => {
