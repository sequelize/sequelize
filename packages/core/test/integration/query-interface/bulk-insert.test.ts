...
describe('QueryInterface#bulkInsert', () => {
  ...
  it(
    Support.getTestDialectTeaser(
      'should insert multiple rows and return inserted data according to dialect',
    ),
  ...
  it(
    Support.getTestDialectTeaser('should return an array even when inserting a single row'),
    async function testSingleRowInsert() {
