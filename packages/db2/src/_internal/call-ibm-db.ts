 ...
 *
 * ibm_db invokes its callbacks outside of a Node.js callback scope, so since Node.js 26.4 (nodejs/node#62969)
 * microtasks and next ticks queued from them (such as promise continuations) do not run until another macrotask happens.
