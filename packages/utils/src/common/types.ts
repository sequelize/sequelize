...
// eslint-disable-next-line @typescript-eslint/ban-types -- "{}" is banned because people think it means "object" when it actually means "any non-nullish value". This gives it a better name.
...
// eslint-disable-next-line @typescript-eslint/ban-types -- we banned NonNullable for NonNullish for clarity, but it's just an alias
