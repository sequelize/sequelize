...
export const noSchemaParameter = deprecate(noop, 'The schema parameter has been deprecated, use a TableName object to specify the schema or set the schema globally in the options.', 'SEQUELIZE0015');
export const noSchemaDelimiterParameter = deprecate(noop, 'The schemaDelimiter parameter has been deprecated, use a TableName object to specify the schemaDelimiter.', 'SEQUELIZE0016');
