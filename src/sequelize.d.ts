...
export interface Options extends Logging {
   ...
   */
  hooks?: Partial<SequelizeHooks<Model>>;
...
export class Sequelize extends Hooks {
  ...
  public static beforeSave<M extends Model>(
    name: string,
    fn: (instance: M, options: UpdateOptions<Attributes<M>> | CreateOptions<CreationAttributes<M>>) => void
  ): void;
  public static beforeSave<M extends Model>(fn: (instance: M, options: UpdateOptions<Attributes<M>> | CreateOptions<CreationAttributes<M>>) => void): void;
