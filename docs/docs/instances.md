...
```js
User.findById(1)
  .then(user => user.increment('my-integer-field', {by: 2}))
  .then(/* ... */)
```
...
```js
User.findById(1)
  .then(user => user.increment([ 'my-integer-field', 'my-very-other-field' ], {by: 2}))
  .then(/* ... */)
```
...
```js
User.findById(1)
  .then(user => user.decrement('my-integer-field', {by: 2}))
  .then(/* ... */)
```
...
```js
User.findById(1)
  .then(user => user.decrement([ 'my-integer-field', 'my-very-other-field' ], {by: 2}))
  .then(/* ... */)
```
