...
| [options.noImplicitTransactions=false] | Boolean | Set to `true` to prevent Sequelize from creating transactions when none is provided. All queries must have transactions provided either explicitly, or via CLS. |
