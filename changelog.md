...
- [REMOVED] Removed count hooks [#xxx](https://github.com/sequelize/sequelize/issues/xxx)
- [ADDED] Added aggregate hooks that are also run for count [#xxx](https://github.com/sequelize/sequelize/issues/xxx)
...
- Removed count hooks. Use the new aggregate hooks instead
