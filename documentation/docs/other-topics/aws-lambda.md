...
1. Lambdas that wait for the event loop to be empty will always time out. `sequelize` connection
   ...
   [`options.pool.evict`](pathname:///api/interfaces/PoolOptions.html#evict)
...
1. Some operations like
   [`Model.findAndCountAll()`](pathname:///api/classes/Model.html#findAndCountAll)
   execute multiple queries asynchronously (e.g.
   [`Model.count()`](pathname:///api/classes/Model.html#count) and
   [`Model.findAll()`](pathname:///api/classes/Model.html#findAll)). Using a maximum of
   ...
   [`ConnectionAcquireTimeoutError`](pathname:///api/classes/ConnectionAcquireTimeoutError.html)
   if a query takes more than the default or configured
   [`options.pool.acquire`](pathname:///api/interfaces/PoolOptions.html#acquire)
...
[Sequelize.prototype.query()](pathname:///api/classes/Sequelize.html#query).
