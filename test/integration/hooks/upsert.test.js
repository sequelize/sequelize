    ...
    describe('#upsert', () => {
      describe('on success', () => {
        it('should run hooks', function() {
          ...
          this.User.addHook('beforeUpsert', beforeHook);
          this.User.addHook('afterUpsert', afterHook);
      ...
      describe('on error', () => {
        it('should return an error from before', function() {
          ...
          this.User.addHook('beforeUpsert', () => {
            beforeHook();
      ...
      describe('preserves changes to values', () => {
        it('beforeUpsert', function() {
          ...
          this.User.addHook('beforeUpsert', values => {
            values.mood = 'happy';
            hookCalled++;
          });
