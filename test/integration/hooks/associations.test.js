    ...
    describe('1:1', () => {
      describe('cascade onUpdate', () => {
        ...
        it('on success', function() {
          ...
          this.Tasks.hooks.add('beforeUpdate', () => {
            beforeHook = true;
            return Promise.resolve();
          });

          this.Tasks.hooks.add('afterUpdate', () => {
            afterHook = true;
            return Promise.resolve();
          });
      ...
      describe('cascade onDelete', () => {
        ...
        describe('#remove', () => {
          it('with no errors', function() {
            ...
            this.Projects.hooks.add('beforeCreate', beforeProject);
            this.Projects.hooks.add('afterCreate', afterProject);
            this.Tasks.hooks.add('beforeDestroy', beforeTask);
            this.Tasks.hooks.add('afterDestroy', afterTask);
          ...
          it('with errors', function() {
            ...
            this.Projects.hooks.add('beforeCreate', () => {
              beforeProject = true;
              return Promise.resolve();
            });

            this.Projects.hooks.add('afterCreate', () => {
              afterProject = true;
              return Promise.resolve();
            });

            this.Tasks.hooks.add('beforeDestroy', () => {
              beforeTask = true;
              return Promise.reject(new Error(CustomErrorText));
            });

            this.Tasks.hooks.add('afterDestroy', () => {
              afterTask = true;
              return Promise.resolve();
            });
      ...
      describe('no cascade update', () => {
        ...
        it('on success', function() {
          ...
          this.Tasks.hooks.add('beforeUpdate', beforeHook);
          this.Tasks.hooks.add('afterUpdate', afterHook);
      ...
      describe('no cascade delete', () => {
        ...
        describe('#remove', () => {
          it('with no errors', function() {
            ...
            this.Projects.hooks.add('beforeCreate', beforeProject);
            this.Projects.hooks.add('afterCreate', afterProject);
            this.Tasks.hooks.add('beforeUpdate', beforeTask);
            this.Tasks.hooks.add('afterUpdate', afterTask);
        ...
        describe('cascade', () => {
          ...
          describe('#remove', () => {
            it('with no errors', function() {
              ...
              this.MiniTasks.hooks.add('beforeDestroy', () => {
                beforeMiniTask = true;
                return Promise.resolve();
              });

              this.MiniTasks.hooks.add('afterDestroy', () => {
                afterMiniTask = true;
                return Promise.resolve();
              });
