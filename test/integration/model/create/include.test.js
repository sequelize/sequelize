  ...
  describe('create', () => {
    describe('include', () => {
      it('should create data for BelongsTo relations', async function () {
        ...
        expect(savedProduct.User.createOptions.parentRecord).to.be.equal(
          savedProduct
        );
      ...
      it('should create data for HasMany relations', async function () {
        ...
        expect(savedProduct.Tags[0].createOptions.myOption).to.be.equal(
          'option'
        );
        expect(savedProduct.Tags[0].createOptions.parentRecord).to.be.equal(
          savedProduct
        );
        expect(savedProduct.Tags[1].createOptions.myOption).to.be.equal(
          'option'
        );
        expect(savedProduct.Tags[1].createOptions.parentRecord).to.be.equal(
          savedProduct
        );
      ...
      it('should create data for BelongsToMany relations', async function () {
        ...
        expect(savedUser.Tasks[0].createOptions.parentRecord).to.be.equal(
          savedUser
        );
        expect(savedUser.Tasks[1].createOptions.myOption).to.be.equal('option');
        expect(savedUser.Tasks[1].createOptions.parentRecord).to.be.equal(
          savedUser
        );
