        ...
        it('should be able to insert data into the table in schema_one using create', function() {
          ...
          return Restaurant.create({
            ...
            return Restaurant.findOne({
              ...
              restaurantId = obj.id;
              return Restaurant.findById(restaurantId, {searchPath: SEARCH_PATH_ONE}).then(function(obj) {
                expect(obj).to.not.be.null;
                expect(obj.foo).to.equal('one');
              });
            });
        ...
        it('should be able to insert data into the table in schema_two using create', function() {
          ...
          return Restaurant.create({
            ...
            return Restaurant.findOne({
              ...
              restaurantId = obj.id;
              return Restaurant.findById(restaurantId, {searchPath: SEARCH_PATH_TWO}).then(function(obj) {
                expect(obj).to.not.be.null;
                expect(obj.foo).to.equal('two');
              });
            });
        ...
        it('should be able to insert data into both schemas using instance.save and retrieve it via findAll', function() {
          ...
          return restaurauntModel.save({searchPath: SEARCH_PATH_ONE}).then(function() {
            ...
            return restaurauntModel.save({searchPath: SEARCH_PATH_ONE}).then(function() {
              ...
              return restaurauntModel.save({searchPath: SEARCH_PATH_TWO}).then(function() {
                restaurauntModel = Restaurant.build({bar: 'two.2'});
                return restaurauntModel.save({searchPath: SEARCH_PATH_TWO}).then(function() {
                  restaurauntModel = Restaurant.build({bar: 'two.3'});
                  return restaurauntModel.save({searchPath: SEARCH_PATH_TWO}).then(function() {
                    return Restaurant.findAll({searchPath: SEARCH_PATH_ONE}).then(function(restaurantsOne) {
                      ...
                      return Restaurant.findAndCountAll({searchPath: SEARCH_PATH_ONE}).then(function(restaurantsOne) {
                        expect(restaurantsOne).to.not.be.null;
                        ...
                        return Restaurant.findAll({searchPath: SEARCH_PATH_TWO}).then(function(restaurantsTwo) {
                          ...
                          return Restaurant.findAndCountAll({searchPath: SEARCH_PATH_TWO}).then(function(restaurantsTwo) {
                            expect(restaurantsTwo).to.not.be.null;
                ...
                return restaurauntModel.save({searchPath: SEARCH_PATH_TWO}).then(function() {
                  ...
                  return restaurauntModel.save({searchPath: SEARCH_PATH_TWO}).then(function() {
                    return Restaurant.findAll({
                      ...
                      return Restaurant.count({searchPath: SEARCH_PATH_ONE}).then(function(count) {
                        ...
                        return Restaurant.findAll({
                          ...
                          restaurantsTwo.forEach(function(restaurant) {
                            expect(restaurant.bar).to.contain('two');
                            return Restaurant.count({searchPath: SEARCH_PATH_TWO}).then(function(count) {
                              expect(count).to.not.be.null;
            ...
            return Restaurant.findOne({
              ...
              return Employee.create({
                ...
                return Restaurant.findOne({
                  ...
                  return obj.getEmployees({searchPath: SEARCH_PATH_ONE}).then(function(employees) {
                    ...
                    return Employee.findOne({
                      ...
                      return obj.getRestaurant({searchPath: SEARCH_PATH_ONE}).then(function(restaurant) {
            ...
            return Restaurant.findOne({
              ...
              return Employee.create({
                ...
                return Restaurant.findOne({
                  ...
                  return obj.getEmployees({searchPath: SEARCH_PATH_TWO}).then(function(employees) {
                    expect(employees.length).to.equal(1);
                    ...
                    return Employee.findOne({
                      ...
                      return obj.getRestaurant({searchPath: SEARCH_PATH_TWO}).then(function(restaurant) {
                        expect(restaurant).to.not.be.null;
