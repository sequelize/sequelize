    ...
    describe('constructor', () => {
      it('handles extended attributes (unique)', function () {
        ...
        expect(
          this.sequelize
            .getQueryInterface()
            .queryGenerator.attributesToSQL(User.rawAttributes)
        ).to.deep.equal({
      ...
      it('handles extended attributes (primaryKey)', function () {
        ...
        expect(
          this.sequelize
            .getQueryInterface()
            .queryGenerator.attributesToSQL(User.rawAttributes)
        ).to.deep.equal({ username: 'VARCHAR(255) PRIMARY KEY' });
      });
      ...
      it('adds timestamps', function () {
        ...
        expect(
          this.sequelize
            .getQueryInterface()
            .queryGenerator.attributesToSQL(User1.rawAttributes)
        ).to.deep.equal({
          id: 'INTEGER NOT NULL auto_increment PRIMARY KEY',
        ...
        expect(
          this.sequelize
            .getQueryInterface()
            .queryGenerator.attributesToSQL(User2.rawAttributes)
        ).to.deep.equal({
          id: 'INTEGER NOT NULL auto_increment PRIMARY KEY',
          updatedAt: 'DATETIME NOT NULL',
          createdAt: 'DATETIME NOT NULL',
    ...
    describe('primaryKeys', () => {
      it('determines the correct primaryKeys', function () {
        ...
        expect(
          this.sequelize
            .getQueryInterface()
            .queryGenerator.attributesToSQL(User.primaryKeys)
        ).to.deep.equal({ foo: 'VARCHAR(255) PRIMARY KEY' });
      });
    });
  });
}
