  ...
  describe('HasMany', () => {
    ...
    describe('removeDAO', () => {
      ...
      it('should correctly remove associated objects', function() {
        ...
        return self.user.getTasks()
          .then(__tasks => {
            expect(__tasks.length).to.equal(0);
            return self.user.setTasks(self.tasks);
          })
          .then(() => {
            return self.user.getTasks();
          })
          .then(_tasks => {
            ...
            return self.user.removeTask(self.tasks[0]);
          })
          .then(() => {
            return self.user.getTasks();
          })
          .then(_tasks => {
            ...
            return self.user.removeTasks([self.tasks[1], self.tasks[2]]);
          })
          .then(() => self.user.getTasks())
          .then(_tasks => {
