...
const catalogNotProvidedError = new Error('A catalog name must be provided to get all foreign keys of a table.');
...
describe('QueryGenerator#getForeignKeysQuery', () => {
  ...
  it('produces a query to get all foreign keys of a table with a catalog', () => {
  ...
  it('produces a query to get all foreign keys of a table from a model with a catalog', () => {
    const MyModel = sequelize.define('myModel', {});

    expectsql(() => queryGenerator.getForeignKeysQuery(MyModel, 'myCatalog'), {
      default: notImplementedError,
      'mariadb mysql': `SELECT CONSTRAINT_NAME as constraint_name,
        CONSTRAINT_NAME as constraintName,
        CONSTRAINT_SCHEMA as constraintSchema,
  ...
  it('produces a query to get all foreign keys of a table with schema in tableName object and a catalog', () => {
    expectsql(() => queryGenerator.getForeignKeysQuery({ tableName: 'myTable', schema: 'mySchema' }, 'myCatalog'), {
      default: notImplementedError,
      'mariadb mysql': `SELECT CONSTRAINT_NAME as constraint_name,
        CONSTRAINT_NAME as constraintName,
        CONSTRAINT_SCHEMA as constraintSchema,
  ...
  it('produces a query to get all foreign keys of a table with default schema in tableName object and a catalog', () => {
    expectsql(() => queryGenerator.getForeignKeysQuery({ tableName: 'myTable', schema: dialect.getDefaultSchema() }, 'myCatalog'), {
      default: notImplementedError,
      'mariadb mysql': `SELECT CONSTRAINT_NAME as constraint_name,
        CONSTRAINT_NAME as constraintName,
        CONSTRAINT_SCHEMA as constraintSchema,
  ...
  it('produces a query to get all foreign keys of a table with globally set schema and a catalog', () => {
    const sequelizeSchema = createSequelizeInstance({ schema: 'mySchema' });
    const queryGeneratorSchema = sequelizeSchema.getQueryInterface().queryGenerator;

    expectsql(() => queryGeneratorSchema.getForeignKeysQuery('myTable', 'myCatalog'), {
      default: notImplementedError,
      'mariadb mysql': `SELECT CONSTRAINT_NAME as constraint_name,
        CONSTRAINT_NAME as constraintName,
        CONSTRAINT_SCHEMA as constraintSchema,
