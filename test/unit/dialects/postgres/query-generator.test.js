    ...
    const suites = {
      ...
      attributesToSQL: [
        ...
        },
        {
          ...
          expectation: {
            id:
              'INTEGER UNIQUE; COMMENT ON COLUMN "foo"."bar"."column" IS \'This is my comment\'',
          },
        },
        // New references style
        {
          arguments: [
            { id: { type: 'INTEGER', references: { model: 'Bar' } } },
          ],
      ...
      createTableQuery: [
        ...
        },
        {
          arguments: [
            'myTable',
            { int: 'INTEGER COMMENT Test', foo: 'INTEGER COMMENT Foo Comment' },
          ],
          expectation:
        ...
        },
        {
          arguments: [
            'myTable',
            { data: current.normalizeDataType(DataTypes.BLOB).toSql() },
          ],
        ...
        },
        {
          arguments: [
            'myTable',
            { data: current.normalizeDataType(DataTypes.BLOB('long')).toSql() },
          ],
          expectation: 'CREATE TABLE IF NOT EXISTS "myTable" ("data" BYTEA);',
        },
        {
        ...
        },
        {
          arguments: [
            'myTable',
            { title: 'ENUM("A", "B", "C")', name: 'VARCHAR(255)' },
          ],
          expectation:
        ...
        },
        {
          arguments: [
            'myTable',
            {
              ...
              name: 'VARCHAR(255)',
              otherId:
                'INTEGER REFERENCES "otherTable" ("id") ON DELETE CASCADE ON UPDATE NO ACTION',
            },
          ],
          expectation:
      ...
      selectQuery: [
        ...
        },
        {
          arguments: [
            'myTable',
            { where: { name: "foo';DROP TABLE myTable;" } },
          ],
          expectation:
        ...
        },
        {
          ...
          expectation:
            'SELECT * FROM "myTable" WHERE (LOWER("user"."name") = \'jan\' AND "myTable"."type" = 1);',
          context: QueryGenerator,
          needsSequelize: true,
        },
        {
          ...
          expectation:
            'SELECT * FROM "myTable" WHERE (LOWER("user"."name") LIKE \'%t%\' AND "myTable"."type" = 1);',
          context: QueryGenerator,
          needsSequelize: true,
        },
        {
          ...
          arguments: [
            ...
            function (sequelize) {
              return {
                order: [
                  [
                    sequelize.fn('f1', sequelize.fn('f2', sequelize.col('id'))),
                    'DESC',
                  ],
                ],
              };
        ...
        {
          title:
            'Combination of sequelize.fn, sequelize.col and { Op.in: ... }',
          arguments: [
            'myTable',
            function (sequelize) {
              return {
        ...
        },
        {
          ...
          arguments: [
            'myTable',
            { where: { field: Buffer.from('Sequelize') } },
          ],
          expectation:
            'SELECT * FROM "myTable" WHERE "myTable"."field" = E\'\\\\x53657175656c697a65\';',
          context: QueryGenerator,
        },
        {
          ...
          arguments: [
            'myTable',
            { where: { aliases: { [Op.contains]: ["Queen's"] } } },
          ],
          expectation:
        ...
        },
        {
          ...
          arguments: [
            'myTable',
            { where: { field: { [Op.regexp]: '^[h|a|t]' } } },
          ],
          expectation:
            'SELECT * FROM "myTable" WHERE "myTable"."field" ~ \'^[h|a|t]\';',
          context: QueryGenerator,
        },
        {
          ...
          arguments: [
            'myTable',
            { where: { field: { [Op.notRegexp]: '^[h|a|t]' } } },
          ],
          expectation:
            'SELECT * FROM "myTable" WHERE "myTable"."field" !~ \'^[h|a|t]\';',
          context: QueryGenerator,
        ...
        },
        {
          ...
          arguments: [
            'myTable',
            { where: { field: { [Op.notIRegexp]: '^[h|a|t]' } } },
          ],
          expectation:
            'SELECT * FROM "myTable" WHERE "myTable"."field" !~* \'^[h|a|t]\';',
          context: QueryGenerator,
      ...
      insertQuery: [
        ...
        },
        {
          ...
          expectation: {
            query:
              'INSERT INTO "myTable" ("name") VALUES ($1) ON CONFLICT DO NOTHING;',
            bind: ['foo'],
          },
        },
        {
        ...
        },
        {
          ...
          expectation: {
            query:
              'INSERT INTO "myTable" ("name") VALUES ($1) ON CONFLICT DO NOTHING RETURNING *;',
            bind: ['foo'],
          },
        },
        {
      ...
      bulkInsertQuery: [
        ...
        },
        {
          ...
          expectation:
            'INSERT INTO "myTable" ("name") VALUES (\'foo\'),(\'bar\') RETURNING *;',
        },
        {
          arguments: [
            'myTable',
        ...
        },
        {
          ...
          expectation:
            'INSERT INTO "mySchema"."myTable" ("name") VALUES (\'foo\'),(\'bar\');',
        },
        {
          arguments: [
            { schema: 'mySchema', tableName: 'myTable' },
      ...
      updateQuery: [
        ...
        },
        {
          ...
          expectation: {
            query:
              'UPDATE "myTable" SET "bar"=$1 WHERE "name" = $2 RETURNING *',
            bind: [2, 'foo'],
          },
        },
        {
        ...
        },
        {
          ...
          expectation: {
            query:
              'UPDATE "myTable" SET "bar"=$1,"nullValue"=$2 WHERE "name" = $3',
            bind: [2, null, 'foo'],
          },
        },
        {
        ...
        },
        {
          ...
          expectation: {
            query:
              'UPDATE "mySchema"."myTable" SET "name"=$1,"birthday"=$2 WHERE "id" = $3',
            bind: [
              'foo',
              moment(
                '2011-03-27 10:01:55 +0000',
        ...
        },
        {
          ...
          expectation: {
            query:
              'UPDATE "mySchema"."myTable" SET "name"=$1 WHERE "name" = $2',
      ...
      renameTrigger: [
        {
          ...
          expectation:
            'ALTER TRIGGER "oldTrigger" ON "myTable" RENAME TO "newTrigger";',
        },
      ],
    ...
    _.each(suites, (tests, suiteTitle) => {
      describe(suiteTitle, () => {
        ...
        tests.forEach((test) => {
          ...
          const title =
            test.title ||
            `Postgres correctly returns ${query} for ${JSON.stringify(
              test.arguments
            )}`;
          it(title, function () {
            ...
            const conditions = this.queryGenerator[suiteTitle](
              ...test.arguments
            );
