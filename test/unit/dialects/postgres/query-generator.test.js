  ...
  const suites = {
    ...
    selectQuery: [
      ...
      },
      {
        ...
        arguments: [
          ...
          function (sequelize) {
            return {
              where: sequelize.and(sequelize.where(sequelize.fn('LOWER', sequelize.col('user.name')), 'LIKE', '%t%'), {
                type: 1
              })
            };
          }
    ...
    insertQuery: [
      ...
      },
      {
        arguments: [
          'myTable',
          { name: 'foo', birthday: moment('2011-03-27 10:01:55 +0000', 'YYYY-MM-DD HH:mm:ss Z').toDate() }
        ],
    ...
    bulkInsertQuery: [
      ...
      },
      {
        arguments: [
          ...
          [
            { name: 'foo', birthday: moment('2011-03-27 10:01:55 +0000', 'YYYY-MM-DD HH:mm:ss Z').toDate() },
            { name: 'bar', birthday: moment('2012-03-27 10:01:55 +0000', 'YYYY-MM-DD HH:mm:ss Z').toDate() }
          ]
        ],
        expectation:
    ...
    updateQuery: [
      ...
      },
      {
        ...
        expectation:
          'UPDATE "mySchema"."myTable" SET "name"=\'foo\',"birthday"=\'2011-03-27 10:01:55.000 +00:00\' WHERE "id" = 2'
      },
      {
        arguments: [
          { tableName: 'myTable', schema: 'mySchema' },
