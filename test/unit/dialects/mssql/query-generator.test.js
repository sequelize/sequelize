  ...
  describe('[MSSQL Specific] QueryGenerator', () => {
    ...
    it('bulkInsertQuery', function() {
      ...
      expectsql(this.queryGenerator.bulkInsertQuery('myTable', [{ name: 'foo' }, { name: 'bar' }]), {
        query: 'INSERT INTO [myTable] ([name]) VALUES (@0),(@1);',
        bind: { 0: 'foo', 1: 'bar' }
      });
      ...
      expectsql(this.queryGenerator.bulkInsertQuery('myTable', [{ username: 'username', firstName: 'firstName', lastName: 'lastName' }, { firstName: 'user1FirstName', lastName: 'user1LastName' }]), {
        query: 'INSERT INTO [myTable] ([username],[firstName],[lastName]) VALUES (@0,@1,@2),(NULL,@3,@4);',
        bind: { 0: 'username', 1: 'firstName', 2: 'lastName', 3: 'user1FirstName', 4: 'user1LastName' }
      });
      ...
      expectsql(this.queryGenerator.bulkInsertQuery('myTable', [{ firstName: 'firstName', lastName: 'lastName' }, { firstName: 'user1FirstName', lastName: 'user1LastName' }]), {
        query: 'INSERT INTO [myTable] ([firstName],[lastName]) VALUES (@0,@1),(@2,@3);',
        bind: { 0: 'firstName', 1: 'lastName', 2: 'user1FirstName', 3: 'user1LastName' }
      });
      ...
      [
        {
          ...
          expectation: {
            query: 'UPDATE [myTable] SET [foo]=[foo]+ @0 OUTPUT INSERTED.*;',
            bind: { 0: 'bar' }
          }
        },
        {
          ...
          expectation: {
            query: 'UPDATE [myTable] SET [foo]=[foo]+ @0 OUTPUT INSERTED.* WHERE [bar] = @1;',
            bind: { 0: 'bar', 1: 'biz' }
          }
        },
        {
          ...
          expectation: {
            query: 'UPDATE [myTable] SET [foo]=[foo]+ @0;',
            bind: { 0: 'bar' }
          }
        },
        {
