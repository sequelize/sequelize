  ...
  suite('[MSSQL Specific] QueryGenerator', () => {
    ...
    test('getForeignKeysQuery', () => {
      expectsql(QueryGenerator.getForeignKeysQuery('myTable'), {
        mssql: "SELECT constraint_name = TC.CONSTRAINT_NAME, constraintName = TC.CONSTRAINT_NAME, constraintSchema = TC.CONSTRAINT_SCHEMA, constraintCatalog = TC.CONSTRAINT_CATALOG, tableName = TC.TABLE_NAME, tableSchema = TC.TABLE_SCHEMA, tableCatalog = TC.TABLE_CATALOG, columnName = KCU.COLUMN_NAME, referencedTableSchema = RTC.TABLE_SCHEMA, referencedTableCatalog = RTC.TABLE_CATALOG, referencedTableName = RTC.TABLE_NAME, referencedColumnName = RKCU.COLUMN_NAME FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS TC INNER JOIN INFORMATION_SCHEMA.KEY_COLUMN_USAGE KCU ON TC.CONSTRAINT_SCHEMA = KCU.CONSTRAINT_SCHEMA AND TC.CONSTRAINT_NAME = KCU.CONSTRAINT_NAME INNER JOIN INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS RC ON TC.CONSTRAINT_SCHEMA = RC.CONSTRAINT_SCHEMA AND TC.CONSTRAINT_NAME = RC.CONSTRAINT_NAME INNER JOIN INFORMATION_SCHEMA.TABLE_CONSTRAINTS RTC ON RC.UNIQUE_CONSTRAINT_SCHEMA = RTC.CONSTRAINT_SCHEMA AND RC.UNIQUE_CONSTRAINT_NAME = RTC.CONSTRAINT_NAME INNER JOIN INFORMATION_SCHEMA.KEY_COLUMN_USAGE RKCU ON RTC.CONSTRAINT_SCHEMA = RKCU.CONSTRAINT_SCHEMA AND RTC.CONSTRAINT_NAME = RKCU.CONSTRAINT_NAME AND KCU.ORDINAL_POSITION = RKCU.ORDINAL_POSITION WHERE TC.CONSTRAINT_TYPE = \'FOREIGN KEY\' AND TC.TABLE_NAME ='myTable'"
      });
    });

    test('getForeignKeyQuery', () => {
      expectsql(QueryGenerator.getForeignKeyQuery('myTable', 'myColumn'), {
        mssql: "SELECT constraint_name = TC.CONSTRAINT_NAME, constraintName = TC.CONSTRAINT_NAME, constraintSchema = TC.CONSTRAINT_SCHEMA, constraintCatalog = TC.CONSTRAINT_CATALOG, tableName = TC.TABLE_NAME, tableSchema = TC.TABLE_SCHEMA, tableCatalog = TC.TABLE_CATALOG, columnName = KCU.COLUMN_NAME, referencedTableSchema = RTC.TABLE_SCHEMA, referencedTableCatalog = RTC.TABLE_CATALOG, referencedTableName = RTC.TABLE_NAME, referencedColumnName = RKCU.COLUMN_NAME FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS TC INNER JOIN INFORMATION_SCHEMA.KEY_COLUMN_USAGE KCU ON TC.CONSTRAINT_SCHEMA = KCU.CONSTRAINT_SCHEMA AND TC.CONSTRAINT_NAME = KCU.CONSTRAINT_NAME INNER JOIN INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS RC ON TC.CONSTRAINT_SCHEMA = RC.CONSTRAINT_SCHEMA AND TC.CONSTRAINT_NAME = RC.CONSTRAINT_NAME INNER JOIN INFORMATION_SCHEMA.TABLE_CONSTRAINTS RTC ON RC.UNIQUE_CONSTRAINT_SCHEMA = RTC.CONSTRAINT_SCHEMA AND RC.UNIQUE_CONSTRAINT_NAME = RTC.CONSTRAINT_NAME INNER JOIN INFORMATION_SCHEMA.KEY_COLUMN_USAGE RKCU ON RTC.CONSTRAINT_SCHEMA = RKCU.CONSTRAINT_SCHEMA AND RTC.CONSTRAINT_NAME = RKCU.CONSTRAINT_NAME AND KCU.ORDINAL_POSITION = RKCU.ORDINAL_POSITION WHERE TC.CONSTRAINT_TYPE = 'FOREIGN KEY' AND TC.TABLE_NAME ='myTable' AND KCU.COLUMN_NAME ='myColumn'"
      });
    });
