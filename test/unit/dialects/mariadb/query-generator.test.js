    ...
    const suites = {
      ...
      createSchema: [
        ...
        },
        {
          ...
          expectation:
            "CREATE SCHEMA IF NOT EXISTS `mySchema` DEFAULT CHARACTER SET 'utf8mb4';",
        },
        {
          arguments: ['mySchema', { collate: 'utf8mb4_unicode_ci' }],
          expectation:
            "CREATE SCHEMA IF NOT EXISTS `mySchema` DEFAULT COLLATE 'utf8mb4_unicode_ci';",
        },
        {
          arguments: [
            'mySchema',
      ...
      createTableQuery: [
        ...
        },
        {
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`data` BLOB) ENGINE=InnoDB;',
        },
        {
          arguments: ['myTable', { data: 'LONGBLOB' }],
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`data` LONGBLOB) ENGINE=InnoDB;',
        },
        {
          arguments: [
            'myTable',
      ...
      selectQuery: [
        ...
        },
        {
          ...
          expectation:
            "SELECT * FROM `myTable` WHERE `myTable`.`field` REGEXP '^[h|a|t]';",
          context: QueryGenerator,
        },
        {
      ...
      insertQuery: [
        ...
        },
        {
          ...
          expectation: {
            query:
              'INSERT INTO `mySchema`.`myTable` (`name`,`foo`) VALUES ($1,$2);',
            bind: ['foo', 1],
          },
          context: { options: { omitNull: true } },
        },
      ...
      selectFromTableFragment: [
        ...
        },
        {
          ...
          expectation:
            'SELECT * FROM `Project` USE INDEX (`index_project_on_name`)',
        },
        {
          arguments: [
            {
              indexHints: [
                { type: IndexHints.FORCE, values: ['index_project_on_name'] },
              ],
            },
            null,
            ['*'],
          ...
          expectation:
            'SELECT * FROM `Project` FORCE INDEX (`index_project_on_name`)',
        },
        {
          arguments: [
            {
              indexHints: [
                { type: IndexHints.IGNORE, values: ['index_project_on_name'] },
              ],
            },
            null,
            ['*'],
          ...
          expectation:
            'SELECT * FROM `Project` IGNORE INDEX (`index_project_on_name`)',
        },
        {
          arguments: [
            {
              indexHints: [
                {
                  type: IndexHints.USE,
                  values: [
                    'index_project_on_name',
                    'index_project_on_name_and_foo',
                  ],
                },
              ],
            },
          ...
          expectation:
            'SELECT * FROM `Project` USE INDEX (`index_project_on_name`,`index_project_on_name_and_foo`)',
        },
        {
          arguments: [
            {
    ...
    _.each(suites, (tests, suiteTitle) => {
      describe(suiteTitle, () => {
        ...
        tests.forEach((test) => {
          ...
          const title =
            test.title ||
            `MariaDB correctly returns ${query} for ${JSON.stringify(
              test.arguments
            )}`;
          it(title, function () {
