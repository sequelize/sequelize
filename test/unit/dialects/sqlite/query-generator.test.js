    ...
    const suites = {
      ...
      createTableQuery: [
        ...
        },
        {
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`data` LONGBLOB);',
        },
        {
          arguments: [
            'myTable',
      ...
      bulkInsertQuery: [
        ...
        },
        {
          ...
          expectation:
            "INSERT INTO `myTable` (`name`) VALUES ('''bar'''),('foo');",
        },
        {
          arguments: [
            'myTable',
        ...
        },
        {
          ...
          expectation:
            "INSERT INTO `myTable` (`name`,`value`) VALUES ('bar',NULL),('foo',1);",
        },
        {
          arguments: [
            'myTable',
          ...
          expectation:
            "INSERT INTO `myTable` (`name`,`value`) VALUES ('bar',NULL),('bar',2);",
        },
        {
          arguments: [
            'myTable',
          ...
          expectation:
            "INSERT INTO `myTable` (`name`,`value`) VALUES ('foo',1),('bar',0);",
        },
        {
          arguments: [
            'myTable',
          ...
          expectation:
            "INSERT INTO `myTable` (`name`,`value`) VALUES ('foo',0),('bar',0);",
        },
        {
          arguments: [
            'myTable',
      ...
      renameColumnQuery: [
        {
          ...
          arguments: [
            ...
            'foo',
            'commit',
            { commit: 'VARCHAR(255)', bar: 'VARCHAR(255)' },
          ],
          expectation:
    ...
    _.each(suites, (tests, suiteTitle) => {
      describe(suiteTitle, () => {
        ...
        tests.forEach((test) => {
          ...
          const title =
            test.title ||
            `SQLite correctly returns ${query} for ${JSON.stringify(
              test.arguments
            )}`;
          it(title, function () {
