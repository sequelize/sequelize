      ...
      it('properly generate alter queries', () => {
        return current.getQueryInterface().changeColumn(Model.getTableName(), 'level_id', {
          ...
          expectsql(sql, {
            ...
            postgres: 'ALTER TABLE "users" ALTER COLUMN "level_id" TYPE FLOAT, ALTER COLUMN "level_id" SET NOT NULL;',
      ...
      it('properly generate alter queries for foreign keys', () => {
        return current.getQueryInterface().changeColumn(Model.getTableName(), 'level_id', {
          ...
          expectsql(sql, {
            ...
            postgres: 'ALTER TABLE "users" ALTER COLUMN "level_id" TYPE INTEGER, ADD FOREIGN KEY ("level_id") REFERENCES "level"("id") ON UPDATE cascade ON DELETE cascade;',
