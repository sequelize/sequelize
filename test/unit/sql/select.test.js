  ...
  describe('select', () => {
    ...
    it('properly stringify IN values as per field definition', () => {
      ...
      expectsql(
        ...
        {
          postgres:
            'SELECT "name", "age", "data" FROM "User" AS "User" WHERE "User"."data" IN (E\'\\\\x313233\');',
          mariadb:
    ...
    describe('attribute escaping', () => {
      it('plain attributes (1)', () => {
        expectsql(
          ...
          {
            default:
              "SELECT '* FROM [User]; DELETE FROM [User];SELECT [id]' FROM [User];",
            mssql:
              'SELECT [* FROM User; DELETE FROM User;SELECT id] FROM [User];',
          }
        );
      ...
      it('plain attributes (3)', () => {
        expectsql(
          ...
          {
            default:
              "SELECT [a', * FROM User; DELETE FROM User;SELECT id] FROM [User];",
            mssql:
              'SELECT [a, * FROM User; DELETE FROM User;SELECT id] FROM [User];',
          }
        );
      ...
      it('plain attributes (4)', () => {
        expectsql(
          ...
          {
            default:
              'SELECT [*, COUNT(*) FROM User; DELETE FROM User;SELECT id] FROM [User];',
          }
        );
      });
      ...
      it('aliased attributes (1)', () => {
        expectsql(
          ...
          {
            default:
              'SELECT [* FROM User; DELETE FROM User;SELECT id] AS [myCol] FROM [User];',
          }
        );
      });
      ...
      it('aliased attributes (3)', () => {
        expectsql(
          ...
          {
            default:
              'SELECT [id] AS [* FROM User; DELETE FROM User;SELECT id] FROM [User];',
          }
        );
      });
                ...
                include: [
                  {
                    attributes: [
                      '* FROM [User]; DELETE FROM [User];SELECT [id]'
                        .replace(
                          /\[/g,
                          Support.sequelize.dialect.TICK_CHAR_LEFT
                        )
                        .replace(
                          /\]/g,
                          Support.sequelize.dialect.TICK_CHAR_RIGHT
                        ),
                    ],
                    association: User.Posts,
                  },
