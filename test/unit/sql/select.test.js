  ...
  describe('select', () => {
    ...
    (function() {
      ...
      testsql({
        ...
        `SELECT * FROM (SELECT "id_user" AS "id", "email", "first_name" AS "firstName", "last_name" AS "lastName" FROM "users" "user" WHERE "user"."companyId" = 1 ORDER BY "user"."last_name" ASC OFFSET 0 ROWS FETCH NEXT 3 ROWS ONLY) AS sub UNION ALL ` +
        `SELECT * FROM (SELECT "id_user" AS "id", "email", "first_name" AS "firstName", "last_name" AS "lastName" FROM "users" "user" WHERE "user"."companyId" = 5 ORDER BY "user"."last_name" ASC OFFSET 0 ROWS FETCH NEXT 3 ROWS ONLY) AS sub) ` +
    ...
    it('properly stringify IN values as per field definition', () => {
      ...
      expectsql(sql.selectQuery('User', {
        ...
        oracle: 'SELECT "name", "age", "data" FROM "User" "User" WHERE "User"."data" IN (X\'313233\');',
