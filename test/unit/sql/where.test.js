        ...
        sql.whereQuery(
          { id: 1 },
          {
            prefix: current.literal(
              sql.quoteTable.call(current.dialect.QueryGenerator, { schema: 'yolo', tableName: 'User' })
            )
          }
        ),
        {
  ...
  describe('whereItemQuery', () => {
    ...
    describe('$notIn', () => {
      ...
      testsql(
        'equipment',
        {
          $notIn: current.literal('(select order_id from product_orders where product_id = 3)')
        },
        {
    ...
    describe('$and/$or/$not', () => {
      describe('$or', () => {
        ...
        testsql('$or', [{ email: 'maker@mhansen.io' }, { email: 'janzeh@gmail.com' }], {
          default: "([email] = 'maker@mhansen.io' OR [email] = 'janzeh@gmail.com')"
        });
      ...
      describe('$and', () => {
        ...
        testsql(
          'name',
          {
            $and: [{ like: '%someValue1%' }, { like: '%someValue2%' }]
          },
          {
    ...
    describe('$col', () => {
      ...
      testsql('$or', [{ ownerId: { $col: 'user.id' } }, { ownerId: { $col: 'organization.id' } }], {
