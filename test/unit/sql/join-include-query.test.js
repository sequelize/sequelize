...
suite(Support.getTestDialectTeaser('SQL'), function() {
  suite('joinIncludeQuery', function () {
    ...
    testsql({
      ...
      oracle: 'LEFT OUTER JOIN company AS Company ON User.company_id = Company.id'
    });
    ...
    testsql({
      ...
      oracle: 'INNER JOIN company AS Company ON User.company_id = Company.id OR Company.public = 1',
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN company AS Company ON User.companyId = Company.id"
    });
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN company AS Company ON User.companyId = Company.id AND Company.name = 'ABC'",
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN user AS Company.Owner ON Company.owner_id = Company.Owner.id_user"
    });
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN profession AS Company.Owner.Profession ON Company.Owner.professionId = Company.Owner.Profession.id"
    });
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN user AS Company.Owner ON Company.ownerId = Company.Owner.id_user"
    });
    ...
    testsql({
      ...
      oracle: "INNER JOIN company AS Company ON User.company_id = Company.id"
    });
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN task AS Tasks ON User.id_user = Tasks.user_id"
    });
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN task AS Tasks ON User.id = Tasks.user_id"
    });
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN task AS Tasks ON (User.id_user = Tasks.user_id OR Tasks.user_id = 2)"
    });
    ...
    testsql({
      ...
      oracle: "LEFT OUTER JOIN task AS Tasks ON Tasks.user_id = User.alternative_id"
    });
  });
});
