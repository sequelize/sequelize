  ...
  describe('DataTypes', () => {
    ...
    describe('UUID', () => {
      ...
      describe('validate', () => {
        ...
        it('should return `true` if `value` is a string and we accept strings', () => {
          ...
          expect(type.validate('foobar', { acceptStrings: true })).to.equal(
            true
          );
        });
      });
    ...
    describe('INTEGER', () => {
      ...
      testsql(
        ...
        DataTypes.INTEGER(11).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        ...
        DataTypes.INTEGER(11).ZEROFILL.UNSIGNED,
        {
          default: 'INTEGER(11) UNSIGNED ZEROFILL',
          sqlite: 'INTEGER(11)',
          postgres: 'INTEGER',
      ...
      describe('validate', () => {
        it('should throw an error if `value` is invalid', () => {
          ...
          expect(() => {
            ...
            Sequelize.ValidationError,
            '"foobar" is not a valid smallint'
          );
          ...
          expect(() => {
            ...
            Sequelize.ValidationError,
            '123.45 is not a valid smallint'
          );
        });
      ...
      describe('validate', () => {
        it('should throw an error if `value` is invalid', () => {
          ...
          expect(() => {
            ...
            Sequelize.ValidationError,
            '"foobar" is not a valid mediumint'
          );
          ...
          expect(() => {
            ...
            Sequelize.ValidationError,
            '123.45 is not a valid mediumint'
          );
        });
    ...
    describe('BIGINT', () => {
      ...
      testsql(
        ...
        DataTypes.BIGINT(11).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        ...
        DataTypes.BIGINT(11).ZEROFILL.UNSIGNED,
        {
          default: 'BIGINT(11) UNSIGNED ZEROFILL',
          sqlite: 'BIGINT(11)',
          postgres: 'BIGINT',
    ...
    describe('REAL', () => {
      ...
      testsql(
        ...
        DataTypes.REAL(11).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        ...
        DataTypes.REAL(11).ZEROFILL.UNSIGNED,
        {
          default: 'REAL(11) UNSIGNED ZEROFILL',
          sqlite: 'REAL UNSIGNED ZEROFILL(11)',
          postgres: 'REAL',
      ...
      testsql(
        'REAL({ length: 11, decimals: 12 }).UNSIGNED',
        DataTypes.REAL({ length: 11, decimals: 12 }).UNSIGNED,
        {
          default: 'REAL(11,12) UNSIGNED',
          sqlite: 'REAL UNSIGNED(11,12)',
          postgres: 'REAL',
      ...
      testsql(
        ...
        DataTypes.REAL(11, 12).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        ...
        DataTypes.REAL(11, 12).ZEROFILL.UNSIGNED,
        {
          default: 'REAL(11,12) UNSIGNED ZEROFILL',
          sqlite: 'REAL UNSIGNED ZEROFILL(11,12)',
          postgres: 'REAL',
    ...
    describe('DOUBLE PRECISION', () => {
      ...
      testsql(
        'DOUBLE({ length: 11 }).UNSIGNED',
        DataTypes.DOUBLE({ length: 11 }).UNSIGNED,
        {
          default: 'DOUBLE PRECISION(11) UNSIGNED',
          sqlite: 'DOUBLE PRECISION UNSIGNED(11)',
          postgres: 'DOUBLE PRECISION',
      ...
      testsql(
        'DOUBLE(11).UNSIGNED.ZEROFILL',
        DataTypes.DOUBLE(11).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        'DOUBLE(11).ZEROFILL.UNSIGNED',
        DataTypes.DOUBLE(11).ZEROFILL.UNSIGNED,
        {
          default: 'DOUBLE PRECISION(11) UNSIGNED ZEROFILL',
          sqlite: 'DOUBLE PRECISION UNSIGNED ZEROFILL(11)',
          postgres: 'DOUBLE PRECISION',
      ...
      testsql(
        'DOUBLE(11, 12).UNSIGNED.ZEROFILL',
        DataTypes.DOUBLE(11, 12).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        'DOUBLE(11, 12).ZEROFILL.UNSIGNED',
        DataTypes.DOUBLE(11, 12).ZEROFILL.UNSIGNED,
        {
          default: 'DOUBLE PRECISION(11,12) UNSIGNED ZEROFILL',
          sqlite: 'DOUBLE PRECISION UNSIGNED ZEROFILL(11,12)',
          postgres: 'DOUBLE PRECISION',
    ...
    describe('FLOAT', () => {
      ...
      testsql(
        ...
        DataTypes.FLOAT(11).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        'FLOAT({ length: 11 }).ZEROFILL',
        DataTypes.FLOAT({ length: 11 }).ZEROFILL,
        {
          default: 'FLOAT(11) ZEROFILL',
          sqlite: 'FLOAT ZEROFILL(11)',
          postgres: 'FLOAT(11)',
      ...
      testsql(
        ...
        DataTypes.FLOAT(11).ZEROFILL.UNSIGNED,
        {
          default: 'FLOAT(11) UNSIGNED ZEROFILL',
          sqlite: 'FLOAT UNSIGNED ZEROFILL(11)',
          postgres: 'FLOAT(11)',
      ...
      testsql(
        ...
        DataTypes.FLOAT({ length: 11, decimals: 12 }).UNSIGNED,
        {
          default: 'FLOAT(11,12) UNSIGNED',
          sqlite: 'FLOAT UNSIGNED(11,12)',
          postgres: 'FLOAT',
      ...
      testsql(
        ...
        DataTypes.FLOAT(11, 12).UNSIGNED.ZEROFILL,
        {
      ...
      testsql(
        ...
        DataTypes.FLOAT(11, 12).ZEROFILL.UNSIGNED,
        {
          default: 'FLOAT(11,12) UNSIGNED ZEROFILL',
          sqlite: 'FLOAT UNSIGNED ZEROFILL(11,12)',
          postgres: 'FLOAT',
    ...
    describe('DECIMAL', () => {
      ...
      testsql(
        ...
        DataTypes.DECIMAL({ precision: 10 }),
        {
          default: 'DECIMAL(10)',
        }
      );
      ...
      testsql(
        ...
        DataTypes.DECIMAL.UNSIGNED.ZEROFILL,
        {
      ...
      describe('validate', () => {
        it('should throw an error if `value` is invalid', () => {
          ...
          expect(() => {
            ...
            Sequelize.ValidationError,
            '"foobar" is not a valid choice in ["foo"]'
          );
        });
