...
module.exports = {
  ...
  oracle: {
    database: process.env.SEQ_ORACLE_DB   || process.env.SEQ_DB   || 'sequelize_test',
    username: process.env.SEQ_ORACLE_USER || process.env.SEQ_USER || 'system',
    password: process.env.SEQ_ORACLE_PW   || process.env.SEQ_PW   || 'system_234',
    host:     process.env.SEQ_ORACLE_HOST || process.env.SEQ_HOST || 'localhost:1521/orcl',
    pool:     {
